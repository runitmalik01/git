...
@PersistenceCapable
public class MemberPersonalInformationEventWorkflowImpl extends WorkflowImpl implements WorkflowEventWorkflow {
    ...
    public MemberPersonalInformationEventWorkflowImpl() throws RemoteException {
    }
