 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://incometaxindiaefiling.gov.in/Corpmaster}DetailsForiegnBank" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://incometaxindiaefiling.gov.in/Corpmaster}DetailsFinancialInterest" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://incometaxindiaefiling.gov.in/Corpmaster}DetailsImmovableProperty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://incometaxindiaefiling.gov.in/Corpmaster}DetailsOthAssets" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://incometaxindiaefiling.gov.in/Corpmaster}DetailsOfAccntsHvngSigningAuth" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://incometaxindiaefiling.gov.in/Corpmaster}DetailsOfTrustOutIndiaTrustee" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ScheduleFA {
    ...
    @XmlElement(name = "DetailsOfTrustOutIndiaTrustee")
    protected List<DetailsOfTrustOutIndiaTrustee> detailsOfTrustOutIndiaTrustee;
    ...
    /**
     * Gets the value of the detailsOfTrustOutIndiaTrustee property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the detailsOfTrustOutIndiaTrustee property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDetailsOfTrustOutIndiaTrustee().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DetailsOfTrustOutIndiaTrustee }
     * 
     * 
     */
    public List<DetailsOfTrustOutIndiaTrustee> getDetailsOfTrustOutIndiaTrustee() {
        if (detailsOfTrustOutIndiaTrustee == null) {
            detailsOfTrustOutIndiaTrustee = new ArrayList<DetailsOfTrustOutIndiaTrustee>();
        }
        return this.detailsOfTrustOutIndiaTrustee;
    }
