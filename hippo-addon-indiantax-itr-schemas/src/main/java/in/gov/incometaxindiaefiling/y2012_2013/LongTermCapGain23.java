...
public class LongTermCapGain23 {
    ...
    @XmlElement(name = "UnlistedSecurities", required = true, defaultValue = "0")
    protected BigInteger unlistedSecurities;
     ...
     *     
     */
    public BigInteger getUnlistedSecurities() {
     ...
     *     
     */
    public void setUnlistedSecurities(BigInteger value) {
