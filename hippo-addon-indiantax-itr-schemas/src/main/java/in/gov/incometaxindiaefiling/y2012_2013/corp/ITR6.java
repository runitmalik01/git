 ...
 *         &lt;element ref="{http://incometaxindiaefiling.gov.in/Corpmaster}PARTA_BSFor6FrmAY13"/>
...
@XmlRootElement(name = "ITR6", namespace = "http://incometaxindiaefiling.gov.in/ITR6")
public class ITR6 {

    @XmlElement(name = "CreationInfo", required = true)
    protected CreationInfo creationInfo;
    @XmlElement(name = "Form_ITR6", required = true)
    protected FormITR6 formITR6;
    @XmlElement(name = "PartA_GEN1", required = true)
    protected PartAGEN1 partAGEN1;
    @XmlElement(name = "PartA_GEN2For6", required = true)
    protected PartAGEN2For6 partAGEN2For6;
    @XmlElement(name = "PARTA_BSFor6FrmAY13", required = true)
    protected PARTABSFor6FrmAY13 partabsFor6FrmAY13;
    ...
    @XmlElement(name = "ScheduleMAT", required = true)
    protected ScheduleMAT scheduleMAT;
    @XmlElement(name = "ScheduleMATC", required = true)
    protected ScheduleMATC scheduleMATC;
    @XmlElement(name = "ScheduleDDT")
    ...
    /**
     * Gets the value of the partabsFor6FrmAY13 property.
     * 
     * @return
     *     possible object is
     *     {@link PARTABSFor6FrmAY13 }
     *     
     */
    public PARTABSFor6FrmAY13 getPARTABSFor6FrmAY13() {
        return partabsFor6FrmAY13;
    }

    /**
     * Sets the value of the partabsFor6FrmAY13 property.
     * 
     * @param value
     *     allowed object is
     *     {@link PARTABSFor6FrmAY13 }
     *     
     */
    public void setPARTABSFor6FrmAY13(PARTABSFor6FrmAY13 value) {
        this.partabsFor6FrmAY13 = value;
    }
