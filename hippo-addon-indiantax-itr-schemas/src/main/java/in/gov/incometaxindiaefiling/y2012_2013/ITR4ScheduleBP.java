...
public class ITR4ScheduleBP {
    ...
    public static class BusinessIncOthThanSpec {
        ...
        @XmlElement(name = "PLUs44sChapXIIG", required = true, defaultValue = "0")
        protected BigInteger plUs44SChapXIIG;
         ...
         *     
         */
        public BigInteger getPLUs44SChapXIIG() {
         ...
         *     
         */
        public void setPLUs44SChapXIIG(BigInteger value) {
