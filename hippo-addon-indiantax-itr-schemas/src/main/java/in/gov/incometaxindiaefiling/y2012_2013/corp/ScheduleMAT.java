 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="ProfAfterTaxPLAcnt">
 *           &lt;simpleType>
...
public class ScheduleMAT {
    ...
    @XmlElement(name = "ProfAfterTaxPLAcnt", defaultValue = "0")
    protected long profAfterTaxPLAcnt;
    ...
    /**
     * Gets the value of the profAfterTaxPLAcnt property.
     * 
     */
    public long getProfAfterTaxPLAcnt() {
        return profAfterTaxPLAcnt;
    }

    /**
     * Sets the value of the profAfterTaxPLAcnt property.
     * 
     */
    public void setProfAfterTaxPLAcnt(long value) {
        this.profAfterTaxPLAcnt = value;
    }
    ...
    public static class Additions {
        ...
        @XmlElement(name = "ITPaidInclDefTax", required = true, defaultValue = "0")
        protected BigInteger itPaidInclDefTax;
        ...
        /**
         * Gets the value of the itPaidInclDefTax property.
         * 
         * @return
         *     possible object is
         *     {@link BigInteger }
         *     
         */
        public BigInteger getITPaidInclDefTax() {
            return itPaidInclDefTax;
        }

        /**
         * Sets the value of the itPaidInclDefTax property.
         * 
         * @param value
         *     allowed object is
         *     {@link BigInteger }
         *     
         */
        public void setITPaidInclDefTax(BigInteger value) {
            this.itPaidInclDefTax = value;
        }
