 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="OthersGrossDtls" maxOccurs="unbounded" minOccurs="0">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
...
public class ScheduleOS {
    ...
    @XmlElement(name = "WinLottRacePuzz", required = true, defaultValue = "0")
    protected BigInteger winLottRacePuzz;
    @XmlElement(name = "TotOthSrcNoRaceHorse", required = true, defaultValue = "0")
    protected BigInteger totOthSrcNoRaceHorse;
    @XmlElement(name = "IncFromOwnHorse")
    protected ScheduleOS.IncFromOwnHorse incFromOwnHorse;
    @XmlElement(name = "IncChargeableFrmOthSrc", required = true, defaultValue = "0")
    protected BigInteger incChargeableFrmOthSrc;
     ...
     *     
     */
    public BigInteger getWinLottRacePuzz() {
     ...
     *     
     */
    public void setWinLottRacePuzz(BigInteger value) {
     ...
     *     
     */
    public BigInteger getTotOthSrcNoRaceHorse() {
     ...
     *     
     */
    public void setTotOthSrcNoRaceHorse(BigInteger value) {
     ...
     *     
     */
    public BigInteger getIncChargeableFrmOthSrc() {
     ...
     *     
     */
    public void setIncChargeableFrmOthSrc(BigInteger value) {
    ...
    public static class IncOthThanOwnRaceHorse {
        ...
        @XmlElement(name = "OthersGrossDtls")
        protected List<ScheduleOS.IncOthThanOwnRaceHorse.OthersGrossDtls> othersGrossDtls;
        ...
        /**
         * Gets the value of the othersGrossDtls property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the othersGrossDtls property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getOthersGrossDtls().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ScheduleOS.IncOthThanOwnRaceHorse.OthersGrossDtls }
         * 
         * 
         */
        public List<ScheduleOS.IncOthThanOwnRaceHorse.OthersGrossDtls> getOthersGrossDtls() {
            if (othersGrossDtls == null) {
                othersGrossDtls = new ArrayList<ScheduleOS.IncOthThanOwnRaceHorse.OthersGrossDtls>();
            }
            return this.othersGrossDtls;
        }
        ...
        public static class OthersGrossDtls {

            @XmlElement(name = "SourceDescription", required = true)
            protected String sourceDescription;
            @XmlElement(name = "SourceAmount", required = true, defaultValue = "0")
            protected BigInteger sourceAmount;
             ...
             *     
             */
            public void setSourceAmount(BigInteger value) {
