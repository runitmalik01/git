...
public class ITR4ScheduleBP {
    ...
    public static class SpecifiedBusinessInc {
        ...
        @XmlElement(name = "ProfitLossSpecifiedBusiness", required = true, defaultValue = "0")
        protected BigInteger profitLossSpecifiedBusiness;
         ...
         *     
         */
        public BigInteger getProfitLossSpecifiedBusiness() {
         ...
         *     
         */
        public void setProfitLossSpecifiedBusiness(BigInteger value) {
