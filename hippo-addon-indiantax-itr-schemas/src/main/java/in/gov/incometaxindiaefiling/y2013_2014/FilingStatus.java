...
public class FilingStatus {
    ...
    @XmlElement(name = "PortugeseCC5A", required = true)
    protected String portugeseCC5A;
    @XmlElement(name = "PANOfSpouse")
    protected String panOfSpouse;
    @XmlElement(name = "NoticeDateUnderSec")
    protected XMLGregorianCalendar noticeDateUnderSec;
     ...
     *     
     */
    public XMLGregorianCalendar getNoticeDateUnderSec() {
     ...
     *     
     */
    public void setNoticeDateUnderSec(XMLGregorianCalendar value) {
