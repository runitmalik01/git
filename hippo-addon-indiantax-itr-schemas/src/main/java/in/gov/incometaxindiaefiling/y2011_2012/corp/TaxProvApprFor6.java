 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TotAppropriations">
 *                     &lt;simpleType>
 *                       &lt;restriction base="{http://www.w3.org/2001/XMLSchema}unsignedLong">
 *                         &lt;totalDigits value="14"/>
 *                       &lt;/restriction>
...
@XmlRootElement(name = "TaxProvApprFor6")
public class TaxProvApprFor6 {

    @XmlElement(name = "ProvForCurrTax", defaultValue = "0")
    protected long provForCurrTax;
    @XmlElement(name = "ProvFBT", defaultValue = "0")
    protected long provFBT;
    ...
    protected TaxProvApprFor6 .Appropriations appropriations;
    @XmlElement(name = "BalToBalSheet", defaultValue = "0")
    protected long balToBalSheet;
    ...
    /**
     * Gets the value of the provFBT property.
     * 
     */
    public long getProvFBT() {
        return provFBT;
    }

    /**
     * Sets the value of the provFBT property.
     * 
     */
    public void setProvFBT(long value) {
        this.provFBT = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TaxProvApprFor6 .Appropriations }
     *     
     */
    public TaxProvApprFor6 .Appropriations getAppropriations() {
     ...
     *     
     */
    public void setAppropriations(TaxProvApprFor6 .Appropriations value) {
        this.appropriations = value;
    }

    /**
     * Gets the value of the balToBalSheet property.
     * 
     */
    public long getBalToBalSheet() {
        return balToBalSheet;
    }

    /**
     * Sets the value of the balToBalSheet property.
     * 
     */
    public void setBalToBalSheet(long value) {
        this.balToBalSheet = value;
    }
    ...
    public static class Appropriations {
        ...
        @XmlElement(name = "AnyOtherAppr", required = true, defaultValue = "0")
        protected BigInteger anyOtherAppr;
        @XmlElement(name = "TotAppropriations", required = true, defaultValue = "0")
