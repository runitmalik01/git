...
mvn -e -DcontrolFY=true -DFY.2012.enabled=true  -P cargo.run -Dcargo.maven.containerId=tomcat7x -Dcargo.maven.containerUrl=http://www.bizdirusa.com/mirrors/apache/tomcat/tomcat-7/v7.0.47/bin/apache-tomcat-7.0.47.zip -Drepo.path=C:\Users\Amit\Projects\cmsrepositories\indiantaxonline -Dcargo.debug.address=9003 -Dcargo.debug.suspend=y
