...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="partD-TaxComputation">
		<div class="row">
			<div class="col-xs-4">
				<div><span class="normallabel">Tax Payable On Total Income</span></div>
				<div>
					<span class="normaltext">	
						<xsl:number grouping-size="3" grouping-separator=","  value="//ITR1_TaxComputation/TotalTaxPayable"/>
					</span>
				</div>
			</div>
			<div class="col-xs-4">
				<div><span class="normallabel">Secondary &amp; Higher Education Cess</span></div>
				<div><span class="normaltext"><xsl:number grouping-size="3" grouping-separator=","  value="//ITR1_TaxComputation/EducationCess"/></span></div>
			</div>
			<div class="col-xs-4">
				<span class="normallabel">80CCD(1)</span>
				<span class="normaltext"><xsl:number grouping-size="3" grouping-separator=","  value="//DeductUndChapVIA/Section80CCDEmployeeOrSE"/></span>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-4">
