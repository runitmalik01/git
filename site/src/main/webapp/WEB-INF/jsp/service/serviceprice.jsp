		...
		<table>
			<tr>
				...
				<c:forEach items="${documents}" var="document">
					<th><c:out value="${document.title}" /></th>
				</c:forEach>
			</tr>
			...
			<tr>
				<th>Compare Plans</th>
				<c:forEach items="${documents}" var="document">
					<th><c:out value="${document.subTitle}" /></th>
				</c:forEach>
			</tr>
			<tr>
				...
				<c:forEach items="${documents}" var="document">
					<th><c:if test="${!fn:contains(document.pricing,'Free') }">
						...
						</c:if> <c:out value="${document.pricing}" /></th>
				</c:forEach>
			</tr>
			...
			<tr>
				<th>Description</th>
				<c:forEach items="${documents}" var="document">
					<th><c:out value="${document.description}" /></th>
				</c:forEach>
			</tr>
			...
			<tr>
				...
				<c:forEach items="${documents}" var="document">
				<th>
				<h5><small> Recommended if you:</small></h5>
					<c:forEach items="${document.features}" var="features">
