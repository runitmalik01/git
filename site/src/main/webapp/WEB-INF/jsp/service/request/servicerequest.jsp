  		...
  		<c:if test="${not empty ReqSuccess}">
  		  <div class="alert alert-success">
  		     <button type="button" class="close" data-dismiss="alert">&times;</button>
  		       <strong><c:out value="Successfully Applied.Your request Number is ${serviceRequestNumber}.Please Note it."/></strong>
  		  </div>
  		</c:if>
...
<c:if test="${not empty documentRequired and documentRequired eq 'true' and not empty serviceRequestNumber}">
  <hst:include ref="servicerequest-docupload"/>
</c:if>
