...
<div class="row show-grid">
	...
	<div class="${sideBarMainClass}">
		...
		<w4india:titleandnav title="Finished Goods"
			subTitle="Schedule QD-(C) aka Quantitative Details of Finished Goods - An assessee has to give information regarding quantitative details of the principal item of goods traded if he is liable for audit under section 44AB and ${subTitle}." />
		<div class="page type-page">
			<c:choose>
				<c:when
					test="${pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD'}">
					<form id="frmmanufacture_FinishedProducts" action="${actionUrl}"
						method="post" name="frmmanufacture_FinishedProducts">
						<legend class="header-color">
							<small><fmt:message key="quantitative.details.itr4.C" /></small>
						</legend>
						<div class="row show-grid">
							<div class="col-md-4">
								<div class="rowlabel">
						...
						<div class="row show-grid">
							...
							<div class="col-md-4">
								...
								<div class="rowlabel">
									<input id="finished_Goods" name="finished_Goods" type="text"
										maxlength="14"
							...
							<div class="col-md-4">
								...
								<div class="rowlabel">
									<input id="sales_Qty" name="sales_Qty" type="text"
										maxlength="14"
				...
				<c:otherwise>
					<table class="table table-bordered">
						...
						<c:if test="${not empty parentBean}">
							<c:forEach
								items="${parentBean.manufactureFinishedGoodsDetailList}"
								var="finishedGoods">
								<tr>
									<td><c:out value="${finishedGoods.item_Name}" /></td>
									<td><c:out value="${finishedGoods.itemUnit_Name}" /></td>
									<td><a class="btn btn-default btn-primary "
										href="${scriptName}/<c:out value="${finishedGoods.canonicalUUID}"/>/manufacture_finishedgoodsedit"><small><i
												class="glyphicon glyphicon-pencil glyphicon glyphicon-white"></i>Edit</small>
											&nbsp;&nbsp; </a>&nbsp;<a class="btn btn-default btn-danger"
										href="${scriptName}/<c:out value="${finishedGoods.canonicalUUID}"/>/manufacture_finishedgoodsdelete"
