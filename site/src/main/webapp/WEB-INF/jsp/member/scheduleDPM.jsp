		...
		<div class="row show-grid">
			...
			<div class="row show-grid">
				<div class="col-md-4 col-md-offset-8 decimal">
					...
					<a id="myModalScheduleDPM" role="button" class="btn btn-default btn-success">Save</a>
				</div>  
				...
				<c:forEach items="${parentBean.scheduleDPMDetailList}"
					...
					<tr>
						...
						<td><a class="btn btn-default btn-danger" style="color: black"
							href="${scriptName}/<c:out value="${scheduleDPM.canonicalUUID}"/>/scheduleDPMedit"><small><i class="glyphicon glyphicon-pencil glyphicon glyphicon-white"></i>Edit</small> &nbsp;&nbsp;
						</a>&nbsp;<a class="btn btn-default btn-primary" style="color:black" href="${scriptName}/<c:out value="${scheduleDPM.canonicalUUID}"/>/scheduleDPMdelete" data-confirm=""><small><i class="glyphicon glyphicon-trash glyphicon glyphicon-white"></i>Delete</small> </a>
							</td>
						</tr>
				</c:forEach>
			</c:if>
