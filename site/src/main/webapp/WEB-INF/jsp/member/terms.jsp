...
<div class="page">
	<h4><w4india:resellername/> - Terms of Use</h4>
	
	<pre>
	1. ACCEPTANCE OF TERMS
	
	<w4india:resellername/> provides a collection of online resources, including classified
	...
	particular <w4india:resellername/> services, you agree to abide by any applicable posted 
	guidelines for all <w4india:resellername/> services, which may change from time to time.  
	Should you object to any term or condition of the Terms of Use, any guidelines, 
	or any subsequent modifications thereto or become dissatisfied with <w4india:resellername/>
	in any way, your only recourse is to immediately discontinue use of <w4india:resellername/>.
	...
	most recent version of the Terms of Use at:
	
	http://www.<w4india:resellername/>.com/termsofuse
	...
	<w4india:resellername/> does not control, and is not responsible for Content made available 
	...
	objectionable. Furthermore, the <w4india:resellername/> site and Content available through 
	the Service may contain links to other websites, which are completely 
	independent of <w4india:resellername/>. <w4india:resellername/> makes no representation or warranty as 
	...
	circumstances will <w4india:resellername/> be liable in any way for any Content or for 
	...
	that <w4india:resellername/> does not pre-screen or approve Content, but that <w4india:resellername/> 
	...
	The <w4india:resellername/> site and Content available through the Service may contain 
	features and functionalities that may link you or provide you with access 
	to third party content which is completely independent of <w4india:resellername/>, 
	...
	You agree that <w4india:resellername/> shall not be responsible or liable for any loss or 
	...
	party, you understand and agree that <w4india:resellername/> is under no obligation to 
	become involved. In the event that you have a dispute with one or more other 
	users, you hereby release <w4india:resellername/>, its officers, employees, agents and 
	...
	otherwise violated, please notify <w4india:resellername/>'s agent for notice of claims of
	copyright or other intellectual property infringement ("Agent"), at
	
	abuse@<w4india:resellername/>.com
	
	or:
	
	Copyright Agent
	<w4india:resellername/>
	...
	a) Identify the material on the <w4india:resellername/> site that you claim is
	...
	<w4india:resellername/> will remove the infringing posting(s), subject to the the procedures
	outlined in the Digital Millenium Copyright Act (DMCA).
	
	
	6. PRIVACY AND INFORMATION DISCLOSURE
	
	<w4india:resellername/> has established a Privacy Policy to explain to users how their
	information is collected and used, which is located at the following web 
	address:  http://www.<w4india:resellername/>.com/privacypolicy
	
	Your use of the <w4india:resellername/> website or the Service signifies acknowledgement of 
	and agreement to our Privacy Policy. You further acknowledge and agree that 
	<w4india:resellername/> may, in its sole discretion, preserve or disclose your Content, 
	...
	protect the rights, property, or personal safety of <w4india:resellername/>, its users or 
	the general public.                
	...
	<w4india:resellername/> employee, or falsely states or otherwise misrepresents your
	...
	posted in areas of the <w4india:resellername/> sites which are not designated for such 
	purposes; or emailed to <w4india:resellername/> users who have not indicated in writing that 
	...
	convenience: http://www.<w4india:resellername/>.com/prohibiteditems
	...
	permitted by <w4india:resellername/>;
	...
	forum, or in more than one area;
	
	x) attempt to gain unauthorized access to <w4india:resellername/>'s computer systems or
	...
	<w4india:resellername/> website; or
	
	y) use any form of automated device or computer program that enables the 
	submission of postings on <w4india:resellername/> without each posting being manually 
	...
	moderate demands on <w4india:resellername/>'s resources, you may not use a Posting 
	Agent to post Content to the Service without express permission or 
	license from <w4india:resellername/>.  Correspondingly, Posting Agents are not 
	...
	license from <w4india:resellername/>.
	
	
	9. NO SPAM POLICY
	
	You understand and agree that sending unsolicited email advertisements to
	<w4india:resellername/> email addresses or through <w4india:resellername/> computer systems, which is
	expressly prohibited by these Terms of Use, will use or cause to be used servers
	located in California.  Any unauthorized use of <w4india:resellername/> computer systems
	...
	event that Content is removed from the Service for violating the Terms of Use.
	
	
	11. LIMITATIONS ON SERVICE
	
	You acknowledge that <w4india:resellername/> may establish limits concerning use of the
	...
	frequency with which you may access the Service. You agree that <w4india:resellername/>
	...
	<w4india:resellername/> reserves the right at any time to modify or discontinue the
	Service (or any part thereof) with or without notice, and that <w4india:resellername/>
	...
	<w4india:resellername/> grants you a limited, revocable, nonexclusive license to access 
	...
	extraction tools for any purpose unless expressly permitted by <w4india:resellername/>. 
	...
	<w4india:resellername/> permits you to display on your website, or create a hyperlink
	...
	absent express permission granted by <w4india:resellername/> to do so.  You may also
	create a hyperlink to the home page of <w4india:resellername/> sites so long as the
	link does not portray <w4india:resellername/>, its employees, or its affiliates in a
	false, misleading, derogatory, or otherwise offensive manner.
	
	<w4india:resellername/> offers various parts of the Service in RSS format so that users
	can embed individual feeds into a personal website or blog, or view postings
	through third party software news aggregators.  <w4india:resellername/> permits you to
	...
	feed, proper attribution to '<w4india:resellername/>' as the source, (d) your use or
	display does not suggest that <w4india:resellername/> promotes or endorses any third
	...
	<w4india:resellername/>'s systems.  <w4india:resellername/> reserves all rights in the content of
	...
	<w4india:resellername/> immediately terminates said permission or license.  In order to
	...
	obtain a license from <w4india:resellername/>.
	
	
	13. TERMINATION OF SERVICE
	
	You agree that <w4india:resellername/>, in its sole discretion, has the right (but not
	...
	if <w4india:resellername/> believes that you have acted inconsistently with the letter or
	spirit of the Terms of Use. Further, you agree that <w4india:resellername/> shall not be liable
	...
	Sections 2, 4, 6 and 12-18 shall survive termination of the Terms of Use.
	...
	written consent of <w4india:resellername/>. You further agree not to reproduce, 
	duplicate or copy Content from the Service without the express written 
	consent of <w4india:resellername/>, and agree to abide by any and all copyright notices 
	...
	aspect of the Service. <w4india:resellername/> is a registered mark in the U.S. Patent 
	and Trademark Office.
	
	Although <w4india:resellername/> does not claim ownership of content that its users post,
	...
	<w4india:resellername/> an irrevocable, perpetual, non-exclusive, fully paid, worldwide
	...
	you automatically grant <w4india:resellername/> all rights necessary to prohibit any 
	...
	YOU AGREE THAT USE OF THE <w4india:resellername/> SITE AND THE SERVICE IS ENTIRELY AT
	YOUR OWN RISK. THE <w4india:resellername/> SITE AND THE SERVICE ARE PROVIDED ON AN "AS
	...
	<w4india:resellername/> DISCLAIMS ANY WARRANTIES FOR THE SECURITY, RELIABILITY,
	TIMELINESS, ACCURACY, AND PERFORMANCE OF THE <w4india:resellername/> SITE AND THE
	SERVICE.  TO THE FULLEST EXTENT PERMITTED BY LAW, <w4india:resellername/> DISCLAIMS ANY
	WARRANTIES FOR OTHER SERVICES OR GOODS RECEIVED THROUGH OR ADVERTISED ON THE
	<w4india:resellername/> SITE OR THE SITES OR SERVICE, OR ACCESSED THROUGH ANY LINKS ON
	THE <w4india:resellername/> SITE.  TO THE FULLEST EXTENT PERMITTED BY LAW, <w4india:resellername/>
	DISCLAIMS ANY WARRANTIES FOR VIRUSES OR OTHER HARMFUL COMPONENTS IN
	CONNECTION WITH THE <w4india:resellername/> SITE OR THE SERVICE.  Some jurisdictions do
	...
	UNDER NO CIRCUMSTANCES SHALL <w4india:resellername/> BE LIABLE FOR DIRECT, INDIRECT,
	INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES (EVEN IF <w4india:resellername/>
	HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), RESULTING FROM ANY
	ASPECT OF YOUR USE OF THE <w4india:resellername/> SITE OR THE SERVICE, WHETHER THE
	DAMAGES ARISE FROM USE OR MISUSE OF THE <w4india:resellername/> SITE OR THE SERVICE, FROM
	INABILITY TO USE THE <w4india:resellername/> SITE OR THE SERVICE, OR THE INTERRUPTION,
	SUSPENSION, MODIFICATION, ALTERATION, OR TERMINATION OF THE <w4india:resellername/> SITE
	...
	ADVERTISED IN CONNECTION WITH THE <w4india:resellername/> SITE OR THE SERVICE OR ANY
	LINKS ON THE <w4india:resellername/> SITE, AS WELL AS BY REASON OF ANY INFORMATION OR
	ADVICE RECEIVED THROUGH OR ADVERTISED IN CONNECTION WITH THE <w4india:resellername/> SITE
	OR THE SERVICE OR ANY LINKS ON THE <w4india:resellername/> SITE.  THESE LIMITATIONS SHALL
	...
	You agree to indemnify and hold <w4india:resellername/>, its officers, subsidiaries,
	...
	The Terms of Use constitute the entire agreement between you and <w4india:resellername/> and
	govern your use of the Service, superseding any prior agreements between you
	and <w4india:resellername/>. The Terms of Use and the relationship between you and <w4india:resellername/>
	shall be governed by the laws of the State of California without regard to
	its conflict of law provisions. You and <w4india:resellername/> agree to submit to the
	personal and exclusive jurisdiction of the courts located within the county
	of San Francisco, California. The failure of <w4india:resellername/> to exercise or
	...
	if it becomes necessary for <w4india:resellername/> to pursue legal action to enforce the 
	Terms of Use, you will be liable to pay <w4india:resellername/> the following amounts as liquidated 
	damages, which you accept as reasonable estimates of <w4india:resellername/>s' damages for 
	the specified breaches of the Terms of Use:
	...
	<w4india:resellername/> one thousand dollars ($1,000) for each such message.
	This provision does not apply to messages that are lawful non-deceptive
	parodies of public figures.
	
	b. If <w4india:resellername/> establishes limits on the frequency with which you may
	access the Service, or terminates your access to or use of the Service, you
	agree to pay <w4india:resellername/> one hundred dollars ($100) for each message posted
	in excess of such limits or for each day on which you access <w4india:resellername/> in
	excess of such limits, whichever is higher.
	
	c. If you send unsolicited email advertisements to <w4india:resellername/> email
	addresses or through <w4india:resellername/> computer systems, you agree to pay
	<w4india:resellername/> twenty five dollars ($25) for each such email.
	
	d. If you post Content in violation of the Terms of Use, other than as described 
	above, you agree to pay <w4india:resellername/> one hundred dollars ($100) for each 
	Item of Content posted.  In its sole discretion, <w4india:resellername/> may elect 
	...
	pay <w4india:resellername/> one hundred dollars ($100) for each and every Item of Conent
	...
	violation of the Terms of Use) agrees to pay <w4india:resellername/> an additional one hundred
	dollars ($100) for each Item of Conent posted by the Posting Agent on 
	behalf of the principal in violation of the Terms of Use.
	...
	violation of the Terms of Use without <w4india:resellername/>'s express written permission, 
	you agree to pay <w4india:resellername/> three thousand dollars ($3,000) for each day 
	on which you engage in such conduct.
	
	Otherwise, you agree to pay <w4india:resellername/>'s actual damages, to the extent such
	actual damages can be reasonably calculated. Notwithstanding any other 
	provision of the Terms of Use, <w4india:resellername/> retains the right to seek the remedy 
	...
	exercise of any power granted in the Terms of Use, or any combination thereof.
