...
<w4india:titleandnav title="Schedule BP" subTitle="Schedule BP&nbsp;-&nbsp;Professional Income earned under
		Rule 6F as Income earned by legal, medical, engineering, architectural
		profession, profession of accountancy, technical consultancy, interior
		decoration, authorised representative and film artist."/>
	...
	<form name="schedBusinessProfess" id="schedBusinessProfess"
		...
		<fieldset>
			<legend class="header-color">
				<small>Presumptive Income under 44AD</small>
			</legend>
		...
		<fieldset>
			<legend class="header-color">
				<small>Presumptive Income under 44AE</small>
			</legend>
			<div class="row show-grid">
				<div class="col-md-4">
					<div class="rowlabel">
		...
		<fieldset>
			<legend class="header-color">
				<small>Financial Particulars of Business</small>
			</legend>
			<div class="row show-grid">
				<div class="col-md-3">
					<div class="rowlabel">
				...
				<div class="col-md-3">
					<div class="rowlabel">
						<label for="grossSundryCredit"> <small>Total
								Sundry Creditors</small>
						</label>
					</div>
					<div class="rowlabel">
				...
				<div class="col-md-3">
					<div class="rowlabel">
						<label for="grossStockTrade"> <small>Total Stock
								In Trade</small>
						</label>
					</div>
					<div class="rowlabel">
				...
				<div class="col-md-3">
					<div class="rowlabel">
						<label for="grossCashBalance"> <small>Total cash
								in Balance</small>
						</label>
					</div>
					<div class="rowlabel">
