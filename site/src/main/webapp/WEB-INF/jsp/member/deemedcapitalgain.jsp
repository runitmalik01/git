...
<div class="page type-page">
	...
	<w4india:titleandnav title="Schedule DCG" subTitle="Schedule DCG aka ${subTitle} as according to section 50 of Income tax act if an assessee has sold a capital asset forming part of block of assets (building, machinery etc) on which the depreciation has been allowed under Income Tax Act, the income arising from such capital asset is treated as short term capital gain."></w4india:titleandnav>
