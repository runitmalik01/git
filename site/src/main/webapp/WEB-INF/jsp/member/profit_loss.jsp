...
<div class="page type-page">
	...
	<form id="frmProfitAndLoss" action="${actionUrl}" method="post"
		...
		<legend class="header-color">
			<small><fmt:message key="profit.loss.itr4" /></small>
		</legend>
			...
			<div class="col-md-3">
				<div class="rowlabel">
					<select id="isAccountMaintain" name="isAccountMaintain">
						...
						<option value="Yes"
							<c:if test="${not empty parentBean.isAccountMaintain && parentBean.isAccountMaintain =='Yes'}">selected</c:if>>Yes</option>
						<option value="No"
							<c:if test="${not empty parentBean.isAccountMaintain && parentBean.isAccountMaintain =='No'}">selected</c:if>>No</option>
					</select>
				</div>
			</div>
		</div>
		<div id="Account_Maintain"
			class="<c:if test="${(parentBean.isAccountMaintain == 'No')}">hide</c:if> ">
			<div class="row show-grid">
				<div class="col-md-8">
					<div class="rowlabel">
			...
			<fieldset>
				<legend class="header-color">
					<small><fmt:message key="profitLoss.fieldset.two.itr4" /></small>
				</legend>
				<div class="row show-grid">
					<div class="col-md-4">
						<div class="rowlabel">
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="service_Tax" name="service_Tax" type="text"
								maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="vat_SalesTax" name="vat_SalesTax" type="text"
								maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="any_OtherTax" name="any_OtherTax" type="text"
							maxlength="14"
			...
			<fieldset>
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="rent" name="rent" type="text" maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="dividend" name="dividend" type="text" maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="interest" name="interest" type="text" maxlength="14"
				...
				<div class="row show-grid">
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="profit_CurrencyFluctuation"
								name="profit_CurrencyFluctuation" type="text" maxlength="14"
					...
					<div class="row show-grid">
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="any_OtherIncome" name="any_OtherIncome" type="text"
									maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="closing_Stocks" name="closing_Stocks" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="opening_Stocks" name="opening_Stocks" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="purchases" name="purchases" type="text" maxlength="14"
			...
			<fieldset>
				<legend class="header-color">
					<small><fmt:message key="duties.taxes.paid.pl.itr4" /></small>
				</legend>
				<div class="row show-grid">
					<div class="col-md-4">
						<div class="rowlabel">
						...
						<div class="rowlabel">
							<input id="custom_Duty" name="custom_Duty" type="text"
								maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="union_ExciseDuty" name="union_ExciseDuty" type="text"
								maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="service_TaxPL" name="service_TaxPL" type="text"
								maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="vat_SalesTaxPL" name="vat_SalesTaxPL" type="text"
								maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="anyOther_TaxPaid" name="anyOther_TaxPaid" type="text"
								maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="freight" name="freight" type="text" maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="power_Fuels" name="power_Fuels" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="rents_PL" name="rents_PL" type="text" maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="repairs_Buildings" name="repairs_Buildings" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="repairs_Machinery" name="repairs_Machinery" type="text"
							maxlength="14"
			...
			<fieldset>
				<legend class="header-color">
					<small><fmt:message key="compensation.to.employees.pl.itr4" /></small>
				</legend>
				<div class="row show-grid">
					<div class="col-md-4">
						<div class="rowlabel">
						...
						<div class="rowlabel">
							<input id="salaries_Wages" name="salaries_Wages" type="text"
								maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="bonus_PL" name="bonus_PL" type="text" maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="reimbursement_MedicalExpenses"
								name="reimbursement_MedicalExpenses" type="text" maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="leave_Encasement" name="leave_Encasement" type="text"
								maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="approved_SuperannuationFund"
								name="approved_SuperannuationFund" type="text" maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="any_OtherFund" name="any_OtherFund" type="text"
								maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="any_otherBenefit" name="any_otherBenefit" type="text"
								maxlength="14"
			...
			<fieldset>
				...
				<div class="row show-grid">
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="life_Insurance" name="life_Insurance" type="text"
								maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="keyman_Insurance" name="keyman_Insurance" type="text"
								maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="other_Insurance" name="other_Insurance" type="text"
								maxlength="14"
			...
			<div class="row show-grid">
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="entertainment_PL" name="entertainment_PL" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="hospitality_PL" name="hospitality_PL" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="conference_PL" name="conference_PL" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="sales_Promotion" name="sales_Promotion" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="advertisement_PL" name="advertisement_PL" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="commission_PL" name="commission_PL" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="boarding_Lodging" name="boarding_Lodging" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="club_Expenses" name="club_Expenses" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="scholarship_PL" name="scholarship_PL" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="gifts_PL" name="gifts_PL" type="text" maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="donation_PL" name="donation_PL" type="text"
							maxlength="14"
			...
			<fieldset>
				<legend class="header-color">
					<small><fmt:message key="rates.taxes.paid.govt.itr4" /></small>
				</legend>
				<div class="row show-grid">
					<div class="col-md-4">
						<div class="rowlabel">
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="service_Tax2" name="service_Tax2" type="text"
								maxlength="14"
					...
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="vat_Salestax2" name="vat_Salestax2" type="text"
								maxlength="14"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="cess_PL" name="cess_PL" type="text" maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="audit_Fee" name="audit_Fee" type="text" maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="other_Expenses" name="other_Expenses" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="bad_Debts" name="bad_Debts" type="text" maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="bad_DoubtfulDebts" name="bad_DoubtfulDebts" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="other_Provisions" name="other_Provisions" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="profitBefore_InterestTaxes"
							name="profitBefore_InterestTaxes" readonly="readonly" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="interest_PL" name="interest_PL" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="prov_CurrentTax" name="prov_CurrentTax" type="text"
							maxlength="14"
				...
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="prov_DeferredTax" name="prov_DeferredTax" type="text"
							maxlength="14"
			...
			<div class="row show-grid">
				<div class="col-md-4">
					...
					<div class="rowlabel">
						<input id="balanceCarried_BalanceSheet"
							name="balanceCarried_BalanceSheet" readonly="readonly"
							type="text" maxlength="14"
		...
		<div id="NoAccount_Maintain"
			class="<c:if test="${(parentBean.isAccountMaintain == 'Yes') ||(empty parentBean.isAccountMaintain)}"> hide</c:if>">
			<fieldset>
				<legend class="header-color">
					<small><fmt:message key="noAccounts.PL.itr4" /></small>
				</legend>
				<div class="row show-grid">
					<div class="col-md-5">
						<div class="rowlabel">
						...
						<div class="rowlabel">
							<input id="gross_Recepients" name="gross_Recepients" type="text"
								maxlength="14"
					...
					<div class="col-md-5">
						...
						<div class="rowlabel">
							<input id="gross_Profit" name="gross_Profit" type="text"
								maxlength="14"
				...
				<div class="row show-grid">
					...
					<div class="col-md-5">
						...
						<div class="rowlabel">
							<input id="net_Profit" name="net_Profit" type="text"
