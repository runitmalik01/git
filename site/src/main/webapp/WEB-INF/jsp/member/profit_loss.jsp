...
<div class="page type-page">
	...
	<div class="row show-grid">
		...
		<div class="${sideBarMainClass}">
			<w4india:titleandnav title="Profit & Loss Account"
				subTitle="Schedule P&L&nbsp;-&nbsp;Under the Income Tax Act, Profits and Gains of Business or Profession' are also subjected to taxation. The term 'business' includes any trade, commerce,manufacture,or any adventure or concern in the nature of trade, commerce or manufacture." />
				...
				<div id="Account_Maintain"
					...
					<fieldset>
						...
						<div class="row show-grid">
							<div class="col-md-4">
								...
								<div class="rowlabel">
									<input id="profit_OtherInvestment"
										name="profit_OtherInvestment" type="text" maxlength="14"
					...
					<div class="row show-grid">
						...
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="purchases" name="purchases" type="text"
									maxlength="14"
					...
					<fieldset>
						<legend class="header-color">
							<small><fmt:message
									key="compensation.to.employees.pl.itr4" /></small>
						</legend>
						<div class="row show-grid">
							<div class="col-md-4">
								<div class="rowlabel">
							...
							<div class="col-md-4">
								...
								<div class="rowlabel">
									<input id="reimbursement_MedicalExpenses"
										name="reimbursement_MedicalExpenses" type="text"
										maxlength="14"
					...
					<fieldset>
						...
						<div class="row show-grid">
							...
							<div class="col-md-4">
								...
								<div class="rowlabel">
									<input id="totalExpense_Insurance"
										name="totalExpense_Insurance" readonly="readonly" type="text"
										maxlength="14"
					...
					<div class="row show-grid">
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="audit_Fee" name="audit_Fee" type="text"
									maxlength="14"
						...
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="bad_Debts" name="bad_Debts" type="text"
									maxlength="14"
						...
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="profitBefore_InterestTaxes"
									name="profitBefore_InterestTaxes" readonly="readonly"
									type="text" maxlength="14"
