...
<div class="row show-grid">
	...
	<div class="${sideBarMainClass}">
		...
		<div class="page">
			<w4india:titleandnav title="Schedule UD"
				subTitle="Schedule UD aka Unabsorbed Depreciation - It has detail of amount of brought forward unabsorbed depreciation for each assessment year, amount of depreciation set-off against the current year's income and the balance unabsorbed depreciation to be carried forward to the next assessment year needs to be mentioned."></w4india:titleandnav>
			<c:choose>
				<c:when
					...
					<table class=" table table-bordered">
						<tr align="center">
							...
							<th width="20%"><b style="color: black;">Amount of
									brought forward unabsorbed depreciation </b></th>
							<th width="20%"><b style="color: black;">Amount of
						...
						<c:if test="${not empty listofValuesDep && not empty parentBean}">
							<c:forEach items="${listofValuesDep}" var="UD">
								<c:forEach
									items="${parentBean.unabsorbedDepreciationDetailList}"
									var="depreciation">
