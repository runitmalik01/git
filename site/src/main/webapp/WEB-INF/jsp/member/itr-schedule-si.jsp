...
<div class="row show-grid">
	...
	<div class="${sideBarMainClass}">
		<w4india:titleandnav title="Schedule SI"
			subTitle="Schedule SI aka Income Tax at Special Rates&nbsp;-&nbsp;Income that is taxable at a
						...
						<c:forEach var="si" items="${scheduleSIList}">
							<c:if test="${scheduleSiDetail.schedulesiSection ==  si.xmlCode}">
								<tr class="warning">
									...
									<td><w4india:inr
											value="${scheduleSiDetail.calcRateIncome}" /></td>
									<td><a
										...
										data-confirm="" class="btn btn-default btn-danger btn-sm">
											<i
											class="glyphicon glyphicon-trash glyphicon glyphicon-white"></i><span><strong>Delete</strong></span>
									</a></td>
								</tr>
							</c:if>
						</c:forEach>
				...
				<tr class="success">
					...
					<td><c:if test="${not empty parentBean.scheduleSiDetailList}">
							...
							<c:forEach items="${parentBean.scheduleSiDetailList}"
								...
								<c:forEach var="si" items="${scheduleSIList}">
									<c:if
										test="${scheduleSiDetail.schedulesiSection ==  si.xmlCode}">
