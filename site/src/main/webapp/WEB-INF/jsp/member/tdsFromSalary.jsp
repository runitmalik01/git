...
<c:choose>
	<c:when
		...
		<form id="frmdatatdssalary" action="${actionUrl}" method="post"
			name="tdsfromsalary">
			<div id="error" class="alert alert-danger" style="display:none;">TAN's fourth alphabet should be first alphabet of Name of Employer</div>
			<fieldset>
				...
				<div class="row show-grid">
					<div class="col-md-4 col-md-offset-8 decimal">
						<a href="${scriptName}" class="button olive">Cancel</a>&nbsp;
								<a id="myModalHreftds" role="button" class="btn btn-default orange">Save</a>
					</div>
					</div>
		</form>
