...
<div><h2><fmt:message key="80IC.schedule"/></h2></div>
     <table> 
		...
		<td align="right">Amount</td>
           ...
           <tr>
	       <td class="label"><fmt:message key="80IC.id1"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id2"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id3"/></td>
	       ...
	       <tr><td class="label" colspan="2"><fmt:message key="80IC.id4"/></td></tr>
	       
	        <tr>
	       <td class="label"><fmt:message key="80IC.id5"/></td>
	       <td class="input"><input type="text" name="id5ic" class="numberinput" id="DIC" value="${documentic.norestAssam }" onblur="fillIC()" title="Please fill this field" maxlength="14" min="0" /></td>
	        ...
	        <tr>
	       <td class="label"><fmt:message key="80IC.id6"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id7"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id8"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id9"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id10"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id11"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id12"/></td>
	       ...
	       <tr>
	       <td class="label"><fmt:message key="80IC.id13"/></td>
