	...
	<c:when
		...
		<form id="frmScheduleDOA" action="${actionUrl}" method="post"
			...
			<div class="col-md-8">
					...
					<div class="col-md-4">
					<div class="rowlabel">
						<input id="valFirstDayPrevYr" name="valFirstDayPrevYr" class="uprcase decimal" type="text" 
		...
		<div class="row show-grid">
			...
			<div class="row show-grid">
				<div class="col-md-4 col-md-offset-8 decimal">
					...
					<a id="myModalScheduleDOA" role="button" class="btn btn-default btn-success">Save</a>
				</div>
				...
				<c:forEach items="${parentBean.scheduleDOADetailList}"
					...
					<tr>
						...
						<td><a class="btn btn-default btn-danger" style="color: black"
							href="${scriptName}/<c:out value="${scheduleDOA.canonicalUUID}"/>/scheduleDOAedit"><small><i class="glyphicon glyphicon-pencil glyphicon glyphicon-white"></i>Edit</small> &nbsp;&nbsp;
						</a>&nbsp;<a class="btn btn-default btn-primary" style="color:black" href="${scriptName}/<c:out value="${scheduleDOA.canonicalUUID}"/>/scheduleDOAdelete" data-confirm=""><small><i class="glyphicon glyphicon-trash glyphicon glyphicon-white"></i>Delete</small> </a>
							</td>
						</tr>
					</tr>
				</c:forEach>
