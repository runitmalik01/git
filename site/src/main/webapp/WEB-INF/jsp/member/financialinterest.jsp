		...
		<form id="frmtFinancialInterest" action="${actionUrl}" method="post"
			...
			<div class="row show-grid">
				<div class="col-md-4 col-md-offset-8 decimal">
					...
					<a id="myModalHrefFinInterest" role="button" class="btn btn-default btn-success" style="color: black">Save</a>
				</div>  
				...
				<c:forEach items="${parentBean.financialInterestDetailList}"
					...
					<tr>
						...
						<td><a class="btn btn-default btn-primary"
							href="${scriptName}/<c:out value="${foreignbank.canonicalUUID}"/>/financialinterestedit"><small><i class="glyphicon glyphicon-pencil glyphicon glyphicon-white"></i>Edit</small>&nbsp;
						</a>&nbsp;<a class="btn btn-default btn-danger" href="${scriptName}/<c:out value="${foreignbank.canonicalUUID}"/>/financialinterestdelete" ><small><i class="glyphicon glyphicon-trash glyphicon glyphicon-white"></i>Delete</small> </a>
							</td>
						</tr>
					</tr>
				</c:forEach>
