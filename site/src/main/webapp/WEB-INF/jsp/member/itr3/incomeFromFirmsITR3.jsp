	...
	<c:choose>
			...
			<form id="frmIncFirms" action="${actionUrl}" method="post"
				...
				<fieldset>
					<legend class="header-color">
						<small><fmt:message key="member.income.from.firms.itr3" /></small>
					</legend>
					<div class="row show-grid">
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="firm_PAN" name="firm_PAN" class="uprcase" type="text"
									maxlength="10"
						...
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="salary_BonusRcv" name="salary_BonusRcv" type="text"
						...
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="interest_Rcv" name="interest_Rcv" type="text"
									maxlength="14" class="decimal"
					...
					<div class="row show-grid">
						...
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="total_SalaryAndInterest"
									name="total_SalaryAndInterest" type="text" maxlength="14"
						...
						<div class="col-md-4">
							...
							<div class="rowlabel">
								<input id="expenses_RelTotal" name="expenses_RelTotal"
				...
				<div class="row show-grid">
					<div class="col-md-4 col-md-offset-8 decimal">
						...
						<a id="myModalIncFirms" role="button"
		...
		<c:otherwise>
			<table class="table table-bordered">
				<tr align="center">
					<th><b><fmt:message key="firm_PAN.schBP.ITR3" /> </b></th>
					<th align="left"><b>Salary, Bonus, Commission</b></th>
					<th align="left"><b><fmt:message
								key="interest_Rcv.schBP.itr3" /> </b></th>
					<th><b><fmt:message
								key="total_SalaryAndInterest.schBP.itr3" /> </b></th>
					<th align="left"><b><fmt:message
								key="expenses_RelTotal.schBP.itr3" /> </b></th>
				...
				<c:if test="${not empty parentBean}">
					<c:forEach items="${parentBean.incFromFirmsDetailList}"
						var="incFromFirms">
						<tr>
							<td><c:out value="${incFromFirms.firm_PAN}" /></td>
							<td><w4india:inr value="${incFromFirms.salary_BonusRcv}" />
							</td>
							<td><w4india:inr value="${incFromFirms.interest_Rcv}" /></td>
							<td><w4india:inr
									value="${incFromFirms.total_SalaryAndInterest}" /></td>
							<td><w4india:inr value="${incFromFirms.expenses_RelTotal}" />
							</td>
							<td><w4india:inr value="${incFromFirms.netIncome}" /></td>
							<td><a class="btn btn-default btn-primary"
								href="${scriptName}/<c:out value="${incFromFirms.canonicalUUID}"/>/incomefromfirmsItr3edit"><small><i
										class="glyphicon glyphicon-pencil glyphicon glyphicon-white"></i>Edit</small>&nbsp;&nbsp;
							</a>&nbsp;<a class="btn btn-default btn-danger"
								href="${scriptName}/<c:out value="${incFromFirms.canonicalUUID}"/>/incomefromfirmsItr3delete"
