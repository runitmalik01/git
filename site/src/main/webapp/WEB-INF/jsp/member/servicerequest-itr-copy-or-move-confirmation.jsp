...
<div class="page">
	<%--<w4india:itrmenu />  --%>
	<h5></h5>
	<a href="../../${newFolderName}/${pan}/servicerequest-itr-summary.html" class="btn btn-primary">Your return was copied successfully. Click here to open the new return</a>
</div>
