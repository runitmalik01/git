				...
				<c:forEach items="${parentBean.manufacture_RawMatDetailList}"
					...
					<tr>
						...
						<td><a class="btn btn-default btn-danger"
							href="${scriptName}/<c:out value="${rawMaterials.canonicalUUID}"/>/manufacture_rawmaterialsedit"><small><i class="glyphicon glyphicon-pencil glyphicon glyphicon-white"></i>Edit</small> &nbsp;&nbsp;
						</a>&nbsp;<a class="btn btn-default btn-primary" href="${scriptName}/<c:out value="${rawMaterials.canonicalUUID}"/>/manufacture_rawmaterialsdelete" data-confirm=""><small><i class="glyphicon glyphicon-trash glyphicon glyphicon-white"></i>Delete</small> </a>
							</td>
						</tr>
