         ...
         <div class="panel-heading">
			...
			<table class="table table-condensed">
		     <tr class="success">
				...
				<tr>
					<td class ="summary-text-color">
					   <a href="incomebusinessprofession.html" class ="summary-href-color">
					...
					<td>
						<div class="btn btn-group" class="decimal">
							...
							<ul class="dropdown-menu">
								<li><a href="incomebusinessprofession.html">
					...
					<td>
						<div class="btn btn-group" class="decimal">
							<button class="btn btn-default btn-sm dropdown-toggle"
								data-toggle="dropdown">
								<c:choose>
								<c:when test="${theForm.partBTTI.taxPaid.taxesPaid.TCS eq'0'}">
								<fmt:message key="summary.button.label" />
								</c:when>
								<c:otherwise>
									<w4india:inr value="${theForm.partBTTI.taxPaid.taxesPaid.TCS}"/>
								</c:otherwise>
								</c:choose>
								<span class="caret"></span>
							</button>
