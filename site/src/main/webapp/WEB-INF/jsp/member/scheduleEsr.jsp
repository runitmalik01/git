			...
			<table>
				...
				<tr>
					...
					<td><input id="amtExcess1" name="amtExcess1"
						...
						readonly="readonly" value="<fmt:formatNumber type="number"  groupingUsed="false" value="${parentBean.amtExcess1}" />" /> 
					</td>
				</tr>
				<tr>
					<td>35(1)(ii)</td>
					...
					<td><input id="amtDebit2" name="amtDebit2" class="decimal" maxlength="14"
						 type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDebit2}" />" />
					</td>
					<td><input id="amtDeduct2" name="amtDeduct2" class="decimal" maxlength="14"
						 type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDeduct2}" />" />
					</td>
					<td><input id="amtExcess2" name="amtExcess2"
						style="background-color: #DFDFDF" class="decimal" 
						readonly="readonly" type="text" value="<fmt:formatNumber type="number"  groupingUsed="false" value="${parentBean.amtExcess2}" />" />
					</td>
				</tr>
				<tr>
					<td>35(1)(iii)</td>
					...
					type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDebit3}" />" /> 
					</td>
					<td><input id="amtDeduct3" name="amtDeduct3" class="decimal" maxlength="14"
						type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDeduct3}" />" /> 
					</td>
					<td><input id="amtExcess3" name="amtExcess3" class="decimal" 
						readonly="readonly" style="background-color: #DFDFDF"
					type="text" value="<fmt:formatNumber type="number" groupingUsed="false" value="${parentBean.amtExcess3}" />" />
					</td>
				</tr>
				<tr>
					<td>35(1)(iv)</td>
					...
					<td><input id="amtDebit4" name="amtDebit4" class="decimal" maxlength="14"
						type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDebit4}" />" />
					</td>
					<td><input id="amtDeduct4" name="amtDeduct4" class="decimal" maxlength="14"
						type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDeduct4}" />" />
					</td>
					<td><input id="amtExcess4" name="amtExcess4" class="decimal"
						readonly="readonly" style="background-color: #DFDFDF"
						type="text" value="<fmt:formatNumber type="number" groupingUsed="false" value="${parentBean.amtExcess4}" />" />
					</td>
				</tr>
				<tr>
					<td>35(2AA)</td>
					...
					<td><input id="amtDebit2AA" name="amtDebit2AA" class="decimal" maxlength="14"
						type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDebit2AA}" />" />
					</td>
					<td><input id="amtDeduct2AA" name="amtDeduct2AA"
						class="decimal" maxlength="14" type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDeduct2AA}" />" />
					</td>
					<td><input id="amtExcess2AA" name="amtExcess2AA"
						style="background-color: #DFDFDF" class="decimal" 
						readonly="readonly" type="text" value="<fmt:formatNumber type="number" groupingUsed="false" value="${parentBean.amtExcess2AA}" />" />
					</td>
				</tr>
				<tr>
					<td>35(2AB)</td>
					...
					<td><input id="amtDebit2AB" name="amtDebit2AB" class="decimal" maxlength="14"
						type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDebit2AB}" />" />
					</td>
					<td><input id="amtDeduct2AB" name="amtDeduct2AB" maxlength="14"
						class="decimal" type="text" value="<fmt:formatNumber type="number"  maxIntegerDigits="14" groupingUsed="false" value="${parentBean.amtDeduct2AB}" />" />
					</td>
					<td><input id="amtExcess2AB" name="amtExcess2AB"
						style="background-color: #DFDFDF" class="decimal" 
						readonly="readonly" type="text" value="<fmt:formatNumber type="number" groupingUsed="false" value="${parentBean.amtExcess2AB}" />" />
					</td>
				</tr>
				<tr>
					<td><b>Total</b></td>
					...
					<td><input id="totalDebit" name="totalDebit" class="decimal"
						readonly="readonly" type="text" value="<fmt:formatNumber type="number" groupingUsed="false" value="${parentBean.totalDebit}" />" />
					</td>
					<td><input id="totalDeduct" name="totalDeduct"
						readonly="readonly" class="decimal"
						type="text" value="<fmt:formatNumber type="number" groupingUsed="false" value="${parentBean.totalDeduct}" />" />
					</td>
					<td><input id="totalExcess" name="totalExcess"
						readonly="readonly" style="background-color: #DFDFDF"
						class="decimal" type="text" value="<fmt:formatNumber type="number" groupingUsed="false" value="${parentBean.totalExcess}" />" />
					</td>
				</tr>
