...
<div class="page">
	...
	Contents
	    ...
	    * Using Information from <w4india:resellername/>
	    * Cookies
	...
	This Privacy Policy describes how we handle your personal information for our services on the <w4india:resellername/> websites. It applies generally to the <w4india:resellername/>.com website and other related websites where this policy appears in the footer of the page. Some <w4india:resellername/>-branded websites or websites we operate may be governed by separate privacy policies. The policy that applies on any of our domains or subdomains is always the policy that appears in the footer of each website.
	
	Our subsidiaries’ and joint ventures’ privacy practices are similar to those described in this Privacy Policy. Subject to the requirements of applicable law, we strive to provide a consistent set of privacy practices throughout the global <w4india:resellername/> community. By accepting the Privacy Policy and the User Agreement in registration, you expressly consent to our collection, storage, use and disclosure of your personal information as described in this Privacy Policy. This Privacy Policy is effective upon acceptance for new users and is otherwise effective on April 1, 2008.
	...
	Your User ID is displayed throughout <w4india:resellername/> and is therefore available to the public. All of your activity on our sites is traceable to your User ID. Other people can see your items that you have purchased in the past, items for sale, feedback, ratings and associated comments, and so on. 
	
	
	Using Information from <w4india:resellername/>
	
	<w4india:resellername/> enables you to share personal and financial information to complete transactions. We encourage you to disclose your privacy practices and respect the privacy of other users. We cannot guarantee the privacy or security of your information and therefore we encourage you to evaluate the privacy and security policies of your trading partner before entering into a transaction and choosing to share your information. To help protect your privacy, we allow only limited access to other users' contact, shipping and financial information to facilitate your transactions. When users are involved in a transaction, they may have access to each other's name, User ID, email address and other contact and shipping information. In all cases, you must give other users a chance to remove themselves from your database and a chance to review what information you have collected about them.
	
	You agree to use user information only for:
	
	    * <w4india:resellername/> transaction-related purposes that are not unsolicited commercial messages;
	    * using services offered through <w4india:resellername/> (e.g. shipping and fraud complaints), or
	    * other purposes that a user expressly chooses. 
	
	
	Cookies
	
	"Cookies" are small files placed on the hard drive of your computer. We use "cookies" (small files placed on your hard drive) on certain of our pages to help analyze our web page flow; customize our services, content and advertising; measure promotional effectiveness, and promote trust and safety. <w4india:resellername/> uses cookies, web beacons, and related tools provided by third parties to provide you with services that make the <w4india:resellername/> site more efficient for your buying and selling activities. <w4india:resellername/> limits the use of these tools to protect your privacy. Most cookies are "session cookies," meaning that they are automatically deleted from your hard drive once you end your session (log out or close your browser).
	...
	<w4india:resellername/> uses cookies on certain pages of the website to:
	...
	Cookies on <w4india:resellername/>'s discussion boards use session cookies to facilitate conversation threads and overall service functions.
	...
	How <w4india:resellername/> protects your privacy with third parties
	
	    * <w4india:resellername/> may work with other companies who place cookies or web beacons on our websites. These companies help operate our websites and provide you with additional products and services. They are subject to confidentiality agreements with <w4india:resellername/> and other legal restrictions. <w4india:resellername/> does not permit any of these companies to collect personal information using cookies or web beacons on our websites.   
	    * Some of these companies like DoubleClick and MediaPlex — maybe our service providers who place cookies that help us serve our own content and compile anonymous site metrics and analytics. We require these companies to use the information they collect only to provide us with these services under contract.
	    * <w4india:resellername/> may participate in cookie-based ad networks operated by Yahoo and Tacoda. This means that these companies may use some anonymous information about you (based on a cookie on your computer) to display ads. We do not permit these companies to collect any personal information about you. Tacoda collects anonymous information using cookies to tailor the advertising you see on the <w4india:resellername/> sites or elsewhere on the web. Yahoo uses some anonymous information we send them (like age range and gender) to display ads on the <w4india:resellername/> sites. Yahoo may also use anonymous information about its own users to select ads to serve on our pages. Click these links to learn more about Yahoo’s{http://info.yahoo.com/privacy/us/yahoo/opt_out/targeting/details.html} and Tacoda’s{http://www.tacoda.com/notice/privacy_policy.html} ad-serving business practices and privacy policies, including how to decline participation in these programs.
	    * <w4india:resellername/> does not permit third-party content on <w4india:resellername/> (such as an item listing) to include cookies or web beacons, although this may still happen from time to time. If you believe a listing may be collecting personal information or using cookies, please report it to spam@<w4india:resellername/>.com.
	
	
	No Spam, Spyware or Spoofing
	
	We and our users do not tolerate spam. Make sure to set your <w4india:resellername/> notification preferences so we communicate to you as you prefer. You are not licensed to add other <w4india:resellername/> users, even a user who has purchased an item from you, to your mailing list (email or physical mail) without their express consent. To report <w4india:resellername/>-related spam or spoof emails to <w4india:resellername/>, please forward the email to spam@<w4india:resellername/>.com or spoof@<w4india:resellername/>.com. You may not use our communication tools to send spam or otherwise send content that would violate our User Agreement. We occasionally scan and may manually filter messages to check for spam, viruses, phishing attacks and other malicious activity or illegal or prohibited content, but we do not permanently store messages sent through these tools. If you send an email to an email address that is not registered in our community (via Refer-a-Friend or other tools), we do not permanently store that email or use that email address for any marketing purpose. We do not rent or sell these email addresses.
	
	
	Account Protection
	
	Your password is the key to your account. Use unique numbers, letters and special characters, and do not disclose your <w4india:resellername/> password to anyone. If you do share your password or your personal information with others, remember that you are responsible for all actions taken in the name of your account. If you lose control of your password, you may lose substantial control over your personal information and may be subject to legally binding actions taken on your behalf. Therefore, if your password has been compromised for any reason, you should immediately notify <w4india:resellername/> and change your password.
	
	
	Accessing, Reviewing and Changing Your Personal Information
	
	You can see, review and change most of your personal information by signing on to <w4india:resellername/>. Generally, we will not manually modify your personal information because it is very difficult to verify your identity remotely. You must promptly update your personal information if it changes or is inaccurate. Once you make a public posting, you may not be able to change or remove it. Upon your request, we will close your account and remove your personal information from view as soon as reasonably possible, based on your account activity and in accordance with applicable law. We do retain personal information from closed accounts to comply with law, prevent fraud, collect any fees owed, resolve disputes, troubleshoot problems, assist with any investigations, enforce our <w4india:resellername/> User Agreement, and take other actions otherwise permitted by law.
