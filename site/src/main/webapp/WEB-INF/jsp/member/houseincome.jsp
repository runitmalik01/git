	...
	<form id="frmdata" action="${actionUrl}" method="post"
		...
		<fieldset>
			...
			<div class="row-fluid show-grid">
					<div class="span4">
						...
						<div>
							<select name="letout" ><option value="">Select a
									value</option>
				...
				<div class="row-fluid show-grid">
					<div class="span6">
						...
						<div>
							<select name="Coowned" ><option value="">Select
									a value</option>
								<option value="Y">Yes</option>
								<option value="N">No</option>
							</select>
					...
					<div class="span6">
						...
						<div>
							<input id="Property_share" name="Property_share" type="text" placeholder="Enter the % share by you in property"
		...
		<fieldset>
			...
			<div class="row-fluid show-grid">
				...
				<div class="span7 decimal">
					<div class="rowlabel">
						<label for=""><small>Tax paid to local authorities</small>
						</label>
					</div>
				</div>
				<div class="span2 offset1">
			...
			<div class="row-fluid show-grid">
				...
				<div class="span2 offset1">
					<div>
						<input id="Total" name="Total" placeholder="Rs."
							type="text"
		...
		<table>
				...
				<c:if test="${not empty parentBean}">
					<c:forEach items="${parentBean.houseIncomeDetailList}"
						...
						<tr>
							<td><a
								href="${redirectURLToSamePage}/<c:out value="${houseincomedetail.canonicalUUID}"/>/edit"><c:out
										value="${houseincomedetail.letOut}" />
							</a>
							</td>
