...
<form id="frmRating" action="${actionUrl}" method="post" name="pi">
	<fmt:message key="rebate.section89.query" />
	<select id="project_billing_code_id">
		<option value="">
			<fmt:message key="member.resi.status.select.one" />
		</option>
		<option value="1">
		...
		<div id="demo" class="yui3-module">
			...
			<div class="yui3-bd" align="center">
				<table id="prevtable">
					...
					<tr>
						<td><input type='text' size='8' name='prevyear1'
							id='prevyear1' value="${prev0.prevYear }" /></td>
					...
					<tr>
						<td><input type='text' size='8' name='prevyear2'
							id='prevyear2' value="${prev1.prevYear }" /></td>
					...
					<tr>
						<td><input type='text' size='8' name='prevyear3'
							id='prevyear3' value="${prev2.prevYear }" /></td>
				...
				<table class="rebate_section89">
					...
					<tr height="30px">
						...
						<td class="input"><c:if test="${ not empty document}">
								...
								<input type="text" name="arrears"
									...
									id="arrears" title="Enter Arrears" class="numberinput" readonly="readonly"/>
							</c:if></td>
					</tr>
					<tr height="30px">
						<td class="label"><fmt:message
					...
					<tr height="30px">
						...
						<td class="input"><c:if test="${ not empty document}">
								<input type="text" name="diff" value="${document.diff}"
									id="diff"
					...
					<tr height="30px">
						<td class="label"><fmt:message
								key="rebate.section89.tax.paid" /></td>
						<td class="input"><c:if test="${ not empty document}">
		...
		<table>
			<tr height="40px">
				...
				<td class="submit fright" colspan="2" align="center"><input
					type="submit" name=" Next " height="38px" value="Next" width="90px"
					onclick="Date()" /></td>
			</tr>
		</table>
	</div>
