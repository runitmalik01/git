		...
		<form id="frmdata" action="${actionUrl}" name="frm16" method="post">
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						<td><label> (a) Entertainment allowance</label></td>
					...
					<tr>
						<td><label>(b) Tax on Employment</label></td>
				...
				<table>
					...
					<tr>
						<td><label><strong>6.</strong> </label> <label>Income
								chargeable under the head."Salaries"(3-5) </label></td>
					...
					<table>
						<tr>
							...
							<td><input type="text" class="numberinput decimal"
								value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
								name="ded_underchapter_6a" placeholder="Rs."></td>
						</tr>
						<tr>
							<th><label>(A) sections 80C, 80CCC and 80CCD </label></th>
							<th></th>
						...
						<tr>
							<td><label>(a) section 80C </label></td>
						</tr>
						<tr>
						...
						<tr>
							<td><label>(c) section 80CCD </label></td>
							<td></td>
							<td><input type="text"
								value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
				...
				<table>
					<tr>
						<th><label>(B) other sections (e.g., 80E, 80G etc.)
								under Chapter VI-A</label></th>
						<th><label>Gross amount </label></th>
						<th><label>Qualifying amount </label></th>
						<th><label>Deductible amount</label></th>
					</tr>
					<tr>
						<td><label> (a) section <input type="text"
								value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
								name="a_section" placeholder="(a)section"> </label></td>
						<td><input type="text"
							value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
					...
					<tr>
						<td><label>(b) section <input type="text"
								value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
								name="b_section" placeholder="(b)section"> </label></td>
						...
						<td><input type="text" name="b_section_3"
							class="numberinput decimal" value="" placeholder="Rs."></td>
					</tr>
					<tr>
						<td><label>(c) section <input type="text"
								value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
								name="c_section" placeholder="(c)section"> </label></td>
					...
					<tr>
						<td><label>(d) section <input type="text"
								value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
								name="d_section" placeholder="(d)section"> </label></td>
					...
					<tr>
						<td><label>(e) section <input type="text"
								value="<c:if test="${(pageAction == 'EDIT_CHILD' || pageAction == 'NEW_CHILD')}"><c:out value="${childBean.year4}"/></c:if>"
								name="e_section" placeholder="(e)section"> </label></td>
				...
				<table>
					...
					<tr>
						<td><label><strong>13.</strong> </label> <label>Surcharge
								(on tax computed at S. No. 12)</label></td>
					...
					<tr>
						<td><label> <strong>14.</strong>Education Cess @2%
								(on tax at S. No. 12 plus surcharge at S. No. 13)</label></td>
						<td></td>
						<td></td>
					...
					<tr>
						<td><label><strong>16.</strong> </label> <label>Relief
								under section 89 (attach details) </label></td>
					...
					<tr>
						<td><label> (a) Tax Deducted at Source u/s 192(1)</label></td>
						<td></td>
					...
					<tr>
						<td><label>(b) Tax paid by the employer on behalf of
								the employee u/s 192(1A) on perquisites u/s 17(2)</label></td>
						<td></td>
					...
					<tr>
						<td><label><strong>19.</strong> </label> <label>Tax
								payable/refundable (17-18)</label></td>
						<td></td>
				...
				<c:forEach items="${parentBean.formSixteenDetailList}"
					...
					<tr>
						...
						<td align="right"><c:out
								value="${salaryItemDetail.aggregate}" /></td>
						<td><a
