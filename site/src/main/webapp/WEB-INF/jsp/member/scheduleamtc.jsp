...
<div class="row show-grid">
	...
	<div class="${sideBarMainClass}">
		<w4india:titleandnav title="Schedule AMTC"
			subTitle="Schedule AMTC aka Alternative Minimum Tax Credit - It is computation of tax credit under section 115JD in whcih credit for AMT paid in assessment year and subsequent assessment years, in excess of normal tax liability, is allowed to be set-off against the normal tax liability of current assessment year." />
		...
		<c:if test="${not empty exceedErrorGrossTurnOver}">
			<div class="alert alert-danger">
				<strong><fmt:message
						key="busi.prof.exceed.grosturnover.itr4" /></strong><a
					href="./servicerequest-itr.html"
					class="btn btn-default btn-warning">Change Package</a>
			</div>
		</c:if>
		<form name="scheduleAMTC" id="scheduleAMTC" action="${actionUrl}"
			...
			<fieldset>
				<legend class="header-color">
					<small>Computation of Tax U/S 115JC</small>
				</legend>
				<div class="row show-grid">
					<div class="col-md-8">
						<div class="rowlabel">
							<label for="taxUndSec115JC"><small>Tax U|S 115JC
									in Assessment Yr ${assessmentYear}</small> </label>
						</div>
					</div>
					<div class="col-md-4">
						<div class="rowlabel">
				...
				<div class="row show-grid">
					<div class="col-md-8">
						<div class="rowlabel">
							<label for="taxUnderOtherProv"><small>Tax under
									Other Provision in Assessment Yr <c:out
					...
					<div class="col-md-4">
						<div class="rowlabel">
							<input id="taxUnderOtherProv" name="taxUnderOtherProv"
				...
				<div class="row show-grid">
					<div class="col-md-8">
						<div class="rowlabel">
							<label for="taxAgainstCredit"><small>Amount of
									Tax Against which Credit Available</small> </label>
						</div>
					</div>
					<div class="col-md-4">
						<div class="rowlabel">
				...
				<fieldset>
					<legend class="header-color">
						<small>Utilisation of AMT credit available for Assessment
							Year ${assessmentYear}</small>
					</legend>
					<div class="row show-grid">
						<div class="col-md-4">
							<div class="rowlabel">
						...
						<div class="col-md-4">
							<div class="rowlabel">
								<label for="amtCreditBrghtFwrd"> <small>AMT
										Credit Brought Forward</small>
								</label>
							</div>
							<div class="rowlabel">
					...
					<div class="row show-grid">
						<div class="col-md-4">
							<div class="rowlabel">
								<label for="amtCreditUnlisted"> <small>AMT
										Credit Unlisted in Current year</small>
								</label>
							</div>
							<div class="rowlabel">
								<input id="amtCreditUnlisted" name="amtCreditUnlisted"
									type="text" maxlength="14" class="decimal"
				...
				<div class="row show-grid">
					<div class="col-md-4">
						...
						<div class="rowlabel">
							<input id="unlistCreditUndSec115JD"
								name="unlistCreditUndSec115JD" type="text" maxlength="14"
								class="decimal" value="${parentBean.unlistCreditUndSec115JD}"
								readonly="readonly" />
						</div>
					</div>
					<div class="col-md-5">
						<div class="rowlabel">
							<label for="liabAvailCredit"> <small>AMT
									liability Available for Credit in Assessment year</small>
							</label>
						</div>
						<div class="rowlabel">
