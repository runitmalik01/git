	...
	<c:otherwise>
		...
		<form class="form" name="memberticket" action="<hst:actionURL />"
			...
			<div class="row show-grid">
				<div class="col-md-3">Name<span style="color: red">*</span></div>
				<div class="col-md-8">
		...
		<div class="row show-grid">
				...
				<div class="col-md-8">	<textarea cols="40" rows="20" name="comments" id="comments"></textarea><br>
				</div>
			</div>
			<div class="row show-grid">
				<div class="col-md-3">Resolution</div>
				<div class="col-md-8">	<textarea cols="40" rows="20" name="resolution" id="resolution"></textarea><br>
				</div>
			</div>
