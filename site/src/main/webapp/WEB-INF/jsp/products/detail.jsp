  ...
  <div id="product" class="product-item">
      ...
      <div class="yui-cssbase body">
          <div id="editable_cont" class="inline-editor-editable-container">
              <span class="<c:if test="${preview}">editable</c:if>" id="mootlywcm:summary"><c:out value="${document.summary}"/></span>
              <span class="<c:if test="${preview}">editable</c:if> inline" id="mootlywcm:description"><hst:html hippohtml="${document.description}"/></span>
          ...
          <li class="content">
              <form id="frmRating" action="${actionUrl}" method="post">
                  <table>
                      ...
                      <tr>
                          <td class="label label-default vtop"><fmt:message key="products.detail.score"/></td>
                          <td class="input">
                              <ol class="rate">
