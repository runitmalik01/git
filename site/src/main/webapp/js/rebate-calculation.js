...
function calculate(){
	...
	var arrears2=$m('#arrears2').val()-0;
	var arrears3=$m('#arrears3').val()-0;
	$m('#arrears').val(arrears1+arrears2+arrears3);
        var totalsalary=parseInt($m('#salaryincome').val())+parseInt($m('#otherincome').val());
	var sum=parseInt($m('#salaryincome').val())+parseInt($m('#otherincome').val())+parseInt($m('#arrears').val());
    $m('#totalincomearrears').val(sum);
     var taxsalaryincome=Math.round(((totalsalary*10.3)/100)*100)/100;
    $m('#taxsalaryincome').val(taxsalaryincome);
    var taxarrears=Math.round(((sum*10.3)/100)*100)/100;
    $m('#taxarrears').val(taxarrears);
    var diff=parseInt(taxarrears)-parseInt(taxsalaryincome);
    $m('#diff').val(diff);
	...
	if(income1!=""){
		var taxincome=Math.round(((income1*10.3)/100)*100)/100;
		$m('#taxincome1').val(taxincome);
	}
	if(income2!=""){
		var taxincome=Math.round(((income2*10.3)/100)*100)/100;
		$m('#taxincome2').val(taxincome);
	}
	if(income3!=""){
		var taxincome=Math.round(((income3*10.3)/100)*100)/100;
	...
	if(income1!=""&&arrears1==""){
		...
		$m('#taxontotal1').val(Math.round(((income1*10.3)/100)*100)/100);
		$m('#taxdiff1').val("0");
	}
	if(income2!=""&&arrears2==""){
		$m('total2').val(income1);
		$m('#taxontotal2').val(Math.round(((income2*10.3)/100)*100)/100);
		$m('#taxdiff2').val("0");
	}
	if(income3!=""&&arrears3==""){
		$m('total3').val(income3);
		$m('#taxontotal3').val(Math.round(((income3*10.3)/100)*100)/100);
		$m('#taxdiff3').val("0");
	}
	...
	if(income1!=""&&arrears1!=""){
		$m('#total1').val(total1);
		var taxincome1=Math.round(((income1*10.3)/100)*100)/100;
		var taxontotal1=Math.round(((total1*10.3)/100)*100)/100;
	...
	if(income2!=""&&arrears2!=""){
		$m('#total2').val(total2);
		var taxincome2=Math.round(((income2*10.3)/100)*100)/100;
		var taxontotal2=Math.round(((total2*10.3)/100)*100)/100;
	...
	if(income3!=""&&arrears3!=""){
		$m('#total3').val(total3);
		var taxincome3=Math.round(((income3*10.3)/100)*100)/100;
		var taxontotal3=Math.round(((total3*10.3)/100)*100)/100;
	...
	var diff=$m('#diff').val();
	if(diff!=""){
		var computedtabletotal=$m('#computedtabletotal').val()-0;
                  var testdiff=parseInt(diff)-parseInt(computedtabletotal);
               if(testdiff<0){
		$m('#taxpaid').val(0);
                   }else{
                   $m('#taxpaid').val(testdiff);
