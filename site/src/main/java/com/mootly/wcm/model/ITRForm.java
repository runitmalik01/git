...
public enum ITRForm {
	...
	ITR1("ITR-1",new ITRServiceDelivery[] {ITRServiceDelivery.DIY,ITRServiceDelivery.Assisted,ITRServiceDelivery.SemiAssisted},1),
	@XmlEnumValue(value = "ITR2")
	ITR2("ITR-2",new ITRServiceDelivery[] {ITRServiceDelivery.DIY,ITRServiceDelivery.Assisted,ITRServiceDelivery.SemiAssisted},2),
	@XmlEnumValue(value = "ITR3")
	ITR3("ITR-3",new ITRServiceDelivery[] {ITRServiceDelivery.DIY,ITRServiceDelivery.Assisted,ITRServiceDelivery.SemiAssisted},3),
	@XmlEnumValue(value = "ITR4")
	ITR4("ITR-4",new ITRServiceDelivery[] {ITRServiceDelivery.DIY,ITRServiceDelivery.Assisted,ITRServiceDelivery.SemiAssisted},4),
	@XmlEnumValue(value = "ITR5")
	ITR4S("ITR-4S",new ITRServiceDelivery[] {ITRServiceDelivery.DIY,ITRServiceDelivery.Assisted,ITRServiceDelivery.SemiAssisted},5),
