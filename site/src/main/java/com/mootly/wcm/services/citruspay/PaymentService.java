...
public interface PaymentService {
	public static enum BANK_ISSUER {
		...
		YES_BANK("CID004",false,"YES Bank"),
		SBI_BANK("CID005",false,"SBI Bank"),
		...
		HDFC_BANK("CID010",false,"HDFC Bank"),
		IDBI_BANK("CID011",false,"IDBI Bank"),
		STATE_BANK_OF_HYDERABAD("CID012",false,"State Bank of Hyderabad"),
		STATE_BANK_OF_BIKANER_AND_JAIPUR("CID013",false,"State Bank of Bikaner and Jaipur"),
		STATE_BANK_OF_MYSORE("CID014",false,"State Bank of Mysore"),
		...
		BANK_OF_INDIA("CID019",false,"Bank of India"),
		BANK_OF_BARODA_RETAIL_ACCOUNTS("CID020",false,"Bank of Baroda Retail Accounts"),
		BANK_OF_MAHARASHTRA("CID021",false,"Bank of Maharashtra"),
		CATHOLIC_SYRIAN_BANK("CID022",false,"Catholic Syrian Bank"),
		CENTRAL_BANK_OF_INDIA("CID023",false,"Central Bank of India"),
		CITY_UNION_BANK("CID024",false,"City Union Bank"),
		CORPORATION_BANK("CID025",false,"Corporation Bank"),
		DCB_BANK_DEVELOPMENT_CREDIT_BANK("CID026",false,"DCB Bank ( Development Credit Bank )"),
		INDIAN_OVERSEAS_BANK("CID027",false,"Indian Overseas Bank"),
		...
		KARNATAKA_BANK("CID031",false,"Karnataka Bank"),
		KARURVYSYA_BANK("CID032",false,"KarurVysya Bank"),
		KOTAK_MAHINDRA_BANK("CID033",false,"Kotak Mahindra Bank"),
		...
		STATE_BANK_OF_PATIALA("CID043",false,"State Bank of Patiala"),
