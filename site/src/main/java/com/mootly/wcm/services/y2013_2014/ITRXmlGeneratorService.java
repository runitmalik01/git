...
public class ITRXmlGeneratorService extends ITRXmlGeneratorServiceCommon  implements XmlGeneratorService {
	...
	public String generateXml(HstRequest request,HstResponse response) throws Exception {
		...
		if(memberPersonalInformation.getFlexField("flex_string_ITRForm", "").equals("ITR1")){
			log.info("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF::::::::::::;"+ITR1XmlGeneratorService.generateITR1(request, response));
		...
		if(memberPersonalInformation.getFlexField("flex_string_ITRForm", "").equals("ITR3")){
			return ITR3XmlGeneratorService.generateITR3(request, response);
		}
		return null;
	}
	...
	public Map<String,Object> generateXml(FinancialYear financialYear,
		...
		if(memberPersonalInformation.getFlexField("flex_string_ITRForm", "").equals("ITR3")){
			returnMap = ITR3XmlGeneratorService.generateITR3(financialYear, inputBeans);
		}
