...
public class Twenty26ASTDSOnPension extends Twenty26ASGenericRecord{
	...
	static final Logger logger = LoggerFactory.getLogger(Twenty26ASTDSOnPension.class);
	...
	@FormField(name="Name_employee",propertyName="employee",dataTypeValidationTypes={})
	...
	@FormField(name="Name_employer",propertyName="EmployerOrDeductorOrCollecterName",dataTypeValidationTypes={})
	...
	@FormField(name="tdspension",propertyName="TotalTDSSal",dataTypeValidationTypes={})
	...
	@FormField(name="Tan_employer",propertyName="TAN",dataTypeValidationTypes={})
	...
	@FormField(name="Addressslry",propertyName="addressdetail",dataTypeValidationTypes={})
	public  String getAddressdetail() {
		return addressdetail;
	}
	
	@FormField(name="Cityslry",propertyName="city",dataTypeValidationTypes={})
	public  String getCity() {
		return city;
	}
	
	@FormField(name="Stateslry",propertyName="state",dataTypeValidationTypes={})
	public  String getState() {
		return state;
	}
	
	@FormField(name="Pinslry",propertyName="pin",dataTypeValidationTypes={})
	...
	@FormField(name="Gross_salary",propertyName="IncChrgSalToBeCopied",dataTypeValidationTypes={})
	...
	public void copyFromSalary(Twenty26ASTDSOnSalary t) {
		setAddressdetail(t.getAddressdetail());
		setBalance(t.getBalance());
		setCity(t.getCity());
		setDed_ent3(t.getDed_ent3());
		setDeductions_entertainment(t.getDeductions_entertainment());
		setDeductions_tax(t.getDeductions_tax());
		setDeductions_total(t.getDeductions_total());
		setEmpCategory(t.getEmpCategory());
		setEmployee(t.getEmployee());
		setEmployerOrDeductorOrCollecterName(t.getEmployerOrDeductorOrCollecterName());
		setGross_b(t.getGross_b());
		setGross_c(t.getGross_c());
		setGross_total(t.getGross_total());
		setIncChrgSal(t.getIncChrgSal());
		setIncChrgSalToBeCopied(t.getIncChrgSalToBeCopied());
		setIsImportedFromDIT(t.getIsImportedFromDIT());
		setLess_total_2(t.getLess_total_2());
		setPan_employee(t.getPan_employee());
		setPin(t.getPin());
		setRelief_2(t.getRelief_2());
		setState(t.getState());
		setTAN(t.getTAN());
		setTotalTDSSal(t.getTotalTDSSal());
	}
