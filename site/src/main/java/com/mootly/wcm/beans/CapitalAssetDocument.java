		...
		try {
        	...
        	if (capitalasset.getCapitalAssetDetailList() != null && capitalasset.getCapitalAssetDetailList().size() > 0 ){ 
        		...
        		for (CapitalAssetDetail capitalAssetDetail:capitalasset.getCapitalAssetDetailList()) {
        			if(capitalAssetDetail.getCapitalGain() !=null && capitalAssetDetail.getDateAcquisition()!=null && capitalAssetDetail.getCostIndexConsideration()!=null
        					&& capitalAssetDetail.getCostIndexAcquisition()!=null){
        				log.info("get value"+capitalAssetDetail.getCapitalGain());
