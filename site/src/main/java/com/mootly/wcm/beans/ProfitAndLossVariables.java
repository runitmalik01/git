...
public abstract class ProfitAndLossVariables extends BaseDocument implements ContentNodeBinder, FormMapFiller{
	...
	public boolean bind(Object content, javax.jcr.Node node)
		...
		try{
			...
			node.setProperty("mootlywcm:vat_SalesTaxPL", objProfitAndLossDocument.getVat_SalesTaxPL());
	...
	public  Double getVat_SalesTaxPL() {
		if (vat_SalesTaxPL== null) vat_SalesTaxPL = getProperty("mootlywcm:vat_SalesTaxPL");
		return vat_SalesTaxPL;
	}
	...
	public void setVat_SalesTaxPL(Double vat_SalesTaxPL) {
		this.vat_SalesTaxPL = vat_SalesTaxPL;
	}
}
