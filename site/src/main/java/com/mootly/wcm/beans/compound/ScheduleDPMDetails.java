...
@Node(jcrType = "mootlywcm:scheduledpmdetails")
public class ScheduleDPMDetails extends HippoItem implements FormMapFiller {
	static final public String NAMESPACE = "mootlywcm:scheduledpmdetails";   
	static final public String NODE_NAME = ScheduleDPMDetails.class.getName().toLowerCase();
	private final static Logger log = LoggerFactory.getLogger(ScheduleDPMDetails.class); 
	...
	public <T extends HippoBean> void cloneBean(T sourceBean) {
		// TODO Auto-generated method stub
		ScheduleDPMDetails objScheduleDPMDetails = (ScheduleDPMDetails) sourceBean;
