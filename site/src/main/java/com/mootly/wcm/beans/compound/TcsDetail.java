...
public class TcsDetail extends HippoItem implements FormMapFiller {
	...
	static final public String NODE_NAME = TcsDetail.class.getName().toLowerCase();
	...
	public Double getTaxCredited() {
		if (taxCredited == null) taxCredited = getProperty("mootlywcm:taxcredit");
		return taxCredited;
	}
	...
	public Double getTotaltax() {
		if (totaltax == null) totaltax = getProperty("mootlywcm:totaltax");
		return totaltax;
	}
