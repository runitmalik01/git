...
@Node(jcrType = "mootlywcm:quantitativeunitdetail")
public class QuantitativeUnitDetail extends HippoItem implements FormMapFiller {
	static final public String NAMESPACE = "mootlywcm:quantitativeunitdetail";   
	static final public String NODE_NAME = QuantitativeUnitDetail.class.getName().toLowerCase();
	private final static Logger log = LoggerFactory.getLogger(QuantitativeUnitDetail.class); 
   ...
   public final void setItemUnit_Code(String itemUnit_Code){
	...
	public <T extends HippoBean> void cloneBean(T sourceBean) {
		// TODO Auto-generated method stub
		QuantitativeUnitDetail objQntUnitDetail = (QuantitativeUnitDetail) sourceBean;
		setItemUnit_Code(objQntUnitDetail.getItemUnit_Code());
		setItem_Name(objQntUnitDetail.getItem_Name());
		setItemUnit_Name(objQntUnitDetail.getItemUnit_Name());
		setOpening_Stock(objQntUnitDetail.getOpening_Stock());
		setPurchage(objQntUnitDetail.getPurchage());
		setSales_Qty(objQntUnitDetail.getSales_Qty());
		setClosing_Stock(objQntUnitDetail.getClosing_Stock());
		setShortage_IfAny(objQntUnitDetail.getShortage_IfAny());
