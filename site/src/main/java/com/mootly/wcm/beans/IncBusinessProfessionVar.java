...
ContentNodeBinder, FormMapFiller {
	...
	private Double netPL_FromBussProf;
	...
	public boolean bind(Object content, javax.jcr.Node node)
		...
		try {
			...
			node.setProperty("mootlywcm:netPL_FromBussProf",
					objIncBusinessProfessionDoc.getNetPL_FromBussProf());
			node.setProperty(
	...
	public Double getNetPL_FromBussProf() {
		if (netPL_FromBussProf == null)
			netPL_FromBussProf = getProperty("mootlywcm:netPL_FromBussProf");
		return netPL_FromBussProf;
	}
	...
	public void setNetPL_FromBussProf(Double netPL_FromBussProf) {
		this.netPL_FromBussProf = netPL_FromBussProf;
	}
