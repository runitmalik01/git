 ...
 */
@Node(jcrType = "mootlywcm:pbassetdocument")
public class AssetDocument extends BaseDocument implements ContentNodeBinder {
	static final public String NAMESPACE = "mootlywcm:pbassetdocument";
	static final public String NODE_NAME = "Asset";
	...
	public boolean bind(Object content, javax.jcr.Node node) throws ContentNodeBindingException {
		AssetDocument bean = (AssetDocument) content;        
		try {
