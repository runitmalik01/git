...
public abstract class FormSixteenSectionB extends FormSixteenSectionA  implements FormMapFiller{
	...
	public void fill(FormMap formMap) {
		...
		if (formMap.getField("gross_a") == null || formMap.getField("gross_a").getValue().isEmpty()) {
			setGross_a(amtA);
		}
		else{
		...
		if (formMap.getField("gross_b") == null || formMap.getField("gross_b").getValue().isEmpty()) {
			setGross_b(amtB);
		}
		else{
		...
		if (formMap.getField("gross_c") == null || formMap.getField("gross_c").getValue().isEmpty()) {
			setGross_c(amtC);
		}
		else{
		...
		double amtGt=0.0d;
		if (formMap.getField("gross_total") == null || formMap.getField("gross_total").getValue().isEmpty()) {
		...
		double amtLA=0.0;
		if (formMap.getField("less_allowance_1") == null || formMap.getField("less_allowance_1").getValue().isEmpty()) {
		...
		if (formMap.getField("less_rs_1") == null || formMap.getField("less_rs_1").getValue().isEmpty()) {}
		else{
			String strBankdetail=formMap.getField("less_rs_1").getValue();
			double amt= Double.parseDouble(strBankdetail);
			setLess_rs_1(amt);
		}
		if (formMap.getField("less_total_1") == null || formMap.getField("less_total_1").getValue().isEmpty()) {}
		else{
			String strBankdetail=formMap.getField("less_total_1").getValue();
			double amt= Double.parseDouble(strBankdetail);
			setLess_total_1(amt);
		}
		if (formMap.getField("less_allowance_2") == null || formMap.getField("less_allowance_2").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("less_rs_2") == null || formMap.getField("less_rs_2").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("less_total_2") == null || formMap.getField("less_total_2").getValue().isEmpty()) {
		...
		double amtBal=0.0d;
		if (formMap.getField("balance") == null || formMap.getField("balance").getValue().isEmpty()) {
			setBalance(amtBal);
		}
		else{
		...
		if (formMap.getField("deductions_tax") == null || formMap.getField("deductions_tax").getValue().isEmpty()) {
		...
		if (formMap.getField("deductions_entertainment") == null || formMap.getField("deductions_entertainment") .getValue().isEmpty()) {
		...
		if (formMap.getField("deductions_total") == null || formMap.getField("deductions_total").getValue().isEmpty()) {
		...
		if (formMap.getField("income_chargable_total") == null || formMap.getField("income_chargable_total").getValue().isEmpty()) {
		...
		if (formMap.getField("additional_1") == null || formMap.getField("additional_1").getValue().isEmpty()) {}
		else{
			String strBankdetail=formMap.getField("additional_1").getValue();
			double amt= Double.parseDouble(strBankdetail);
			setAdditional_1(amt);
		}
		if (formMap.getField("additional_2") == null || formMap.getField("additional_2").getValue().isEmpty()) {}
		else{
			String strBankdetail=formMap.getField("additional_2").getValue();
			double amt= Double.parseDouble(strBankdetail);
			setAdditional_2(amt);
		}
		if (formMap.getField("gross_income_total") == null || formMap.getField("gross_income_total").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("ded_underchapter_6a") == null || formMap.getField("ded_underchapter_6a").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("c_1") == null || formMap.getField("c_1").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_1").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_1(amt);
		}
		if (formMap.getField("c_2") == null || formMap.getField("c_2").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_2").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_2(amt);
		}
		if (formMap.getField("c_3") == null || formMap.getField("c_3").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_3").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_3(amt);
		}
		if (formMap.getField("c_4") == null || formMap.getField("c_4").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_4").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_4(amt);
		}
		if (formMap.getField("c_5") == null || formMap.getField("c_5").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_5").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_5(amt);
		}
		if (formMap.getField("c_6a") == null || formMap.getField("c_6a").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_6a").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_6a(amt);
		}
		if (formMap.getField("c_6b") == null || formMap.getField("c_6b").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_6b").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_6b(amt);
		}
		if (formMap.getField("c_6c") == null || formMap.getField("c_6c").getValue().isEmpty()) {}
		else{
			String strInt_nsc=formMap.getField("c_6c").getValue();
			double amt= Double.parseDouble(strInt_nsc);
			setC_6c(amt);
		}
		if (formMap.getField("ccc_1") == null || formMap.getField("ccc_1").getValue().isEmpty()) {}
		else{
			String strOther_interest=formMap.getField("ccc_1").getValue();
			double amt= Double.parseDouble(strOther_interest);
			setCcc_1(amt);
		}
		if (formMap.getField("ccc_2") == null || formMap.getField("ccc_2").getValue().isEmpty()) {}
		else{
			String strOther_interest=formMap.getField("ccc_2").getValue();
			double amt= Double.parseDouble(strOther_interest);
			setCcc_2(amt);
		}
		if (formMap.getField("ccd_1") == null || formMap.getField("ccd_1").getValue().isEmpty()) {}
		else{
			String strOther_interest=formMap.getField("ccd_1").getValue();
			double amt= Double.parseDouble(strOther_interest);
			setCcd_1(amt);
		}
		if (formMap.getField("ccd_2") == null || formMap.getField("ccd_2").getValue().isEmpty()) {}
		else{
			String strOther_interest=formMap.getField("ccd_2").getValue();
			double amt= Double.parseDouble(strOther_interest);
			setCcd_2(amt);
		}
		if (formMap.getField("a_section") == null || formMap.getField("a_section").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("a_section").getValue();
			setA_section(strTotal_interest);
		}
		if (formMap.getField("a_section_1") == null || formMap.getField("a_section_1").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("a_section_1").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setA_section_1(amt);
		}
		if ( formMap.getField("a_section_2") == null || formMap.getField("a_section_2").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("a_section_2").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setA_section_2(amt);
		}
		if (formMap.getField("a_section_3") == null || formMap.getField("a_section_3").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("a_section_3").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setA_section_3(amt);
		}
		if (formMap.getField("b_section") == null || formMap.getField("b_section").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("b_section_1") == null || formMap.getField("b_section_1").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("b_section_1").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setB_section_1(amt);
		}
		if (formMap.getField("b_section_2") == null || formMap.getField("b_section_2").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("b_section_2").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setB_section_2(amt);
		}
		if (formMap.getField("b_section_3") == null || formMap.getField("b_section_3").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("b_section_3").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setB_section_3(amt);
		}
		if (formMap.getField("c_section") == null || formMap.getField("c_section").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("c_section").getValue();

			setC_section(strTotal_interest);
		}
		if (formMap.getField("c_section_1") == null || formMap.getField("c_section_1").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("c_section_1").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setC_section_1(amt);
		}
		if (formMap.getField("c_section_2") == null || formMap.getField("c_section_2") .getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("c_section_2").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setC_section_2(amt);
		}
		if (formMap.getField("c_section_3") == null || formMap.getField("c_section_3").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("c_section_3").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setC_section_3(amt);
		}
		if (formMap.getField("d_section") == null || formMap.getField("d_section").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("d_section").getValue();

			setD_section(strTotal_interest);
		}
		if (formMap.getField("d_section_1") == null || formMap.getField("d_section_1").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("d_section_1").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setD_section_1(amt);
		}
		if (formMap.getField("d_section_2") == null || formMap.getField("d_section_2").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("d_section_2").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setD_section_2(amt);
		}
		if (formMap.getField("d_section_3") == null || formMap.getField("d_section_3").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("d_section_3").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setD_section_3(amt);
		}
		if (formMap.getField("e_section") == null || formMap.getField("e_section").getValue().isEmpty()) {}
		else{
			String stre_section=formMap.getField("e_section").getValue();
			setE_section(stre_section);
		}
		if (formMap.getField("e_section_1") == null || formMap.getField("e_section_1") .getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("e_section_1").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setE_section_1(amt);
		}
		if (formMap.getField("e_section_2") == null || formMap.getField("e_section_2").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("e_section_2").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setE_section_2(amt);
		}
		if (formMap.getField("e_section_3") == null || formMap.getField("e_section_3").getValue().isEmpty()) {}
		else{
			String strTotal_interest=formMap.getField("e_section_3").getValue();
			double amt= Double.parseDouble(strTotal_interest);
			setE_section_3(amt);
		}
		if (formMap.getField("aggregate") == null || formMap.getField("aggregate").getValue().isEmpty()) {}
		else{
			String strFamily_pension=formMap.getField("aggregate").getValue();
			double amt= Double.parseDouble(strFamily_pension);
			setAggregate(amt);
		}
		if (formMap.getField("total_income_1") == null || formMap.getField("total_income_1") .getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("total_income_2") == null || formMap.getField("total_income_2").getValue().isEmpty()) {}
		else{
			String strDividends=formMap.getField("total_income_2").getValue();
			double amt= Double.parseDouble(strDividends);
			setTotal_income_2(amt);
		}
		if (formMap.getField("tax_total_income_1") == null || formMap.getField("tax_total_income_1").getValue().isEmpty()) {}
		else{
			String strDividends=formMap.getField("tax_total_income_1").getValue();
			double amt= Double.parseDouble(strDividends);
			setTax_total_income_1(amt);
		}
		if (formMap.getField("tax_total_income_2") == null || formMap.getField("tax_total_income_2").getValue().isEmpty()) {}
		else{
			String strDividends=formMap.getField("tax_total_income_2").getValue();
			double amt= Double.parseDouble(strDividends);
			setTax_total_income_2(amt);
		}
		if (formMap.getField("surcharge_1") == null || formMap.getField("surcharge_1") .getValue().isEmpty()) {}
		else{
			String strDeduction_57=formMap.getField("surcharge_1").getValue();
			double amt= Double.parseDouble(strDeduction_57);
			setSurcharge_1(amt);
		}
		if (formMap.getField("surcharge_2") == null || formMap.getField("surcharge_2").getValue().isEmpty()) {}
		else{
			String strDeduction_57=formMap.getField("surcharge_2").getValue();
			double amt= Double.parseDouble(strDeduction_57);
			setSurcharge_2(amt);
		}
		if (formMap.getField("education_cess") == null || formMap.getField("education_cess").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("tax_payable") == null || formMap.getField("tax_payable").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("relief_1") == null || formMap.getField("relief_1").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("relief_2") == null || formMap.getField("relief_2") .getValue().isEmpty()) {
		...
		if (formMap.getField("tax_payable1") == null || formMap.getField("tax_payable1").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("tax_payable_1") == null || formMap.getField("tax_payable_1").getValue().isEmpty()) {}
		else{
		...
		if (formMap.getField("tax_payable_2") == null || formMap.getField("tax_payable_2") .getValue().isEmpty()) {}
		else{
		...
		double amtDed1=0.0d;
		if (formMap.getField("ded_ent1") == null || formMap.getField("ded_ent1").getValue().isEmpty()) {
			setDed_ent1(amtDed1);
		}
		else{
		...
		if (formMap.getField("ded_ent2") == null || formMap.getField("ded_ent2").getValue().isEmpty()) {}
		else{
		...
		double amtDed3=0.0d;
		if (formMap.getField("ded_ent3") == null || formMap.getField("ded_ent3").getValue().isEmpty()) {
			setDed_ent3(amtDed3);
		}
		else{
		...
		double amtDed4=0.0d;
		if (formMap.getField("ded_ent4") == null || formMap.getField("ded_ent4").getValue().isEmpty()) {
			setDed_ent4(amtDed4);
		}
		else{
		...
		if (formMap.getField("relief_11") == null || formMap.getField("relief_11") .getValue().isEmpty()) {}
		else{
			String strIncome_rent_machine=formMap.getField("relief_11").getValue();
			double amt= Double.parseDouble(strIncome_rent_machine);
			setRelief_11(amt);
		}
		if (formMap.getField("relief_12") == null || formMap.getField("relief_12").getValue().isEmpty()) {}
		else{
			String strIncome_maintain=formMap.getField("relief_12").getValue();
			double amt= Double.parseDouble(strIncome_maintain);
			setRelief_12(amt);
		}
		if ( formMap.getField("uuidform16") != null && formMap.getField("uuidform16").getValue() != null) {
			//log.info("this is uuid of form"+ formMap.getField("uuidform16").getValue());
			setForm16Uuid(formMap.getField("uuidform16").getValue());
		}
		double value_allowNotExempt=0.0d;
		if ( formMap.getField("allowNotExempt") != null && !(formMap.getField("allowNotExempt").getValue().isEmpty())) {
