...
@Node(jcrType = "mootlywcm:securitiesdetail")

@TagAsTaxDataProvider(type=TaxDataProviderType.INCOME)
public class SecuritiesDetail extends HippoItem implements FormMapFiller {
	static final public String NAMESPACE = "mootlywcm:securitiesdetail";
	static final public String NODE_NAME = SecuritiesDetail.class.getName().toLowerCase();
	private final static Logger log = LoggerFactory.getLogger(SecuritiesDetail.class); 
	...
	public <T extends HippoBean> void cloneBean(T sourceBean) {
		...
		// TODO Auto-generated method stub
		SecuritiesDetail objSecuritiesdetail = (SecuritiesDetail) sourceBean;
