...
public class SelfAssesmetTaxDocument extends BaseDocument implements ContentNodeBinder,FormMapFiller,CompoundChildUpdate {
	...
	public final List<SelfAssesmentTaxDetail> getSelfAssesmentDetailList() {
		if (selfAssesmentDetailList == null) selfAssesmentDetailList= getChildBeans(PROP_DETAIL_BEAN);
		return selfAssesmentDetailList;
	}

	public final void setSelfAssesmentDetailList(List<SelfAssesmentTaxDetail> selfAssesmentDetailList) {
		this.selfAssesmentDetailList = selfAssesmentDetailList;
	}
	
	public final void addSelfAssesmentDetail(SelfAssesmentTaxDetail tdsothersdetail) {
		getSelfAssesmentDetailList();
		if (selfAssesmentDetailList == null) selfAssesmentDetailList = new ArrayList<SelfAssesmentTaxDetail>();
	...
	public boolean bind(Object content, javax.jcr.Node node)
		...
		try {
			SelfAssesmetTaxDocument selfasses = (SelfAssesmetTaxDocument) content;
	...
	public <T extends HippoBean> void cloneBean(T sourceBean) {
		...
		SelfAssesmetTaxDocument salaryIncomeDocument = (SelfAssesmetTaxDocument) sourceBean;
	...
	public void update(HippoBean child) {
		...
		if (child.getCanonicalUUID() == null) {
			SelfAssesmentTaxDetail source =(SelfAssesmentTaxDetail) child;
			addSelfAssesmentDetail(source);
		}
		boolean found = false;
		List<SelfAssesmentTaxDetail> listOfChildren = getSelfAssesmentDetailList();
		for (HippoBean o:listOfChildren) {
			...
			if (child.getCanonicalUUID() != null && child.getCanonicalUUID().equals(o.getCanonicalUUID())) {
				...
				SelfAssesmentTaxDetail destination =(SelfAssesmentTaxDetail) o;
				SelfAssesmentTaxDetail source  = (SelfAssesmentTaxDetail) child;
