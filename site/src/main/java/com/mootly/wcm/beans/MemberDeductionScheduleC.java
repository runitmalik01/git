...
public class MemberDeductionScheduleC extends BaseDocument implements ContentNodeBinder,FormMapFiller {
...
//for personal information
	...
	public boolean bind(Object content, javax.jcr.Node node)
		...
		try {
			...
			MemberDeductionScheduleC scheduleC = (MemberDeductionScheduleC) content;
			node.setProperty("mootlywcm:dpone", scheduleC.getDpone());
	    	node.setProperty("mootlywcm:dptwo", scheduleC.getDptwo());
	    	node.setProperty("mootlywcm:dpthree", scheduleC.getDpthree());
	    	node.setProperty("mootlywcm:dpfour", scheduleC.getDpfour());
	    	node.setProperty("mootlywcm:dpfive", scheduleC.getDpfive());
	    	node.setProperty("mootlywcm:dpsix", scheduleC.getDpsix());
	    	node.setProperty("mootlywcm:dpseven", scheduleC.getDpseven());
	    	node.setProperty("mootlywcm:dpeight", scheduleC.getDpeight());
	    	node.setProperty("mootlywcm:dpnine", scheduleC.getDpnine());
	    	node.setProperty("mootlywcm:dpten", scheduleC.getDpten());
	    	node.setProperty("mootlywcm:scheduleCone", scheduleC.getScheduleCone());
	    	node.setProperty("mootlywcm:scheduleCtwo", scheduleC.getScheduleCtwo());
	    	node.setProperty("mootlywcm:scheduleCthree", scheduleC.getScheduleCthree());
	    	node.setProperty("mootlywcm:scheduleCfour", scheduleC.getScheduleCfour());
	    	node.setProperty("mootlywcm:scheduleCfive", scheduleC.getScheduleCfive());
	    	node.setProperty("mootlywcm:scheduleCsix", scheduleC.getScheduleCsix());
	    	node.setProperty("mootlywcm:scheduleCseven", scheduleC.getScheduleCseven());
	    	node.setProperty("mootlywcm:scheduleCeight", scheduleC.getScheduleCeight());
	    	node.setProperty("mootlywcm:scheduleCnine", scheduleC.getScheduleCnine());
	    	node.setProperty("mootlywcm:scheduleCten", scheduleC.getScheduleCten());
	    	node.setProperty("mootlywcm:total", scheduleC.getTotal());
	    	...
	    	/**  javax.jcr.Node prdLinkNode;
              ...
              prdLinkNode.setProperty("hippo:docbase", scheduleC.getPersonalInfoUuid());
	       */
