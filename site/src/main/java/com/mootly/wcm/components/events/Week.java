...
public class Week {
    ...
    /**
     * The ordered list of day of this month. The days start at {@link com.mootly.wcm.components.events.EventCalendarMonth#FIRST_DAY_OF_WEEK}. If the first of last
