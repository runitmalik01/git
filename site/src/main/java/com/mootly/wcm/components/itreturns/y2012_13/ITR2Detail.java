...
public class ITR2Detail extends BaseComponent {

    private static final Logger log = LoggerFactory.getLogger(ITR2Detail.class);
    ...
    public void doBeforeRender(HstRequest request, HstResponse response) {
       ...
       request.setAttribute("formName", "ITR2");
    }
