...
public interface ITReturnScreen {
	 ...
	 public enum PAGE_ACTION {DEFAULT,NEW,EDIT,DELETE,SAVE,NEW_CHILD,EDIT_CHILD,SAVE_CHILD,DELETE_CHILD,SHOW_ITR_SUMMARY,DOWNLOAD_ITR_XML,DOWNLOAD_ITR_SUMMARY,EMAIL_ITR_XML_AND_SUMMARY,DOWNLOAD_ITR_XML_BULK_ADD_TO_SESSION,DOWNLOAD_ITR_XML_BULK};
