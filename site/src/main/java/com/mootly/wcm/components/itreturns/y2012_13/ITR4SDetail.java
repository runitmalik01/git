...
public class ITR4SDetail extends BaseComponent {

    private static final Logger log = LoggerFactory.getLogger(ITR4SDetail.class);
    ...
    public void doBeforeRender(HstRequest request, HstResponse response) {
       ...
       request.setAttribute("formName", "ITR4");
    }
