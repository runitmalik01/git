...
public class LinkedForm extends EmailForm {
    ...
    public FormBean getFormBean(final HstRequest request) {
        ...
        if (document == null || !(document.isHippoDocumentBean()) || !(document instanceof com.mootly.wcm.beans.SimpleDocument)) {
            return null;
        }
        return ((com.mootly.wcm.beans.SimpleDocument) document).getForm();
    }
