...
/** User has to no tax on his income.
 *
 */
public class TestITR1NillTax {
	...
	public void initMemberInfo() {
		...
		memberPersonalInformation.setFirstName("NEHA");
		memberPersonalInformation.setMiddleName("");
		memberPersonalInformation.setLastName("GULATI");
		String name = memberPersonalInformation.getLastName();
		char n = name.charAt(0);
		memberPersonalInformation.setPAN("AIFPG2289N");
		...
		memberPersonalInformation.setFatherName("ASHOK KUMAR GULATI");
		memberPersonalInformation.setFlatDoorBuilding("FLAT NO. 162, 6TH FLOOR");
		memberPersonalInformation.setRoadStreet("");
		memberPersonalInformation.setAreaLocality("CGHS SOCIETY, SECTOR-4, DWARKA");
		...
		memberPersonalInformation.setPinCode("110075");
		memberPersonalInformation.setStdCode("11111");
		memberPersonalInformation.setPhone("");
		memberPersonalInformation.setMobile("9971115836");
		memberPersonalInformation.setEmail("vchaddha2001@gmail.com");
		...
		memberPersonalInformation.setBD_BANK_NAME("PUNJAB NATIONAL BANK");
		memberPersonalInformation.setBD_ADD_BANK_BRANCH("B-73, GREATER KAILASH PART 1, NEW DELHI 110048");
		memberPersonalInformation.setBD_ACC_NUMBER("0604000101391935");
		memberPersonalInformation.setFlexField("flex_string_IFSCCode",vf.createValue("PUNB0099300"));
	...
	public void testTaxRefundSingleSalary () {
		try {
			...
			BigInteger expectedPayTax = new BigInteger("0");		
			...
			formSixteenDetail.setEmployer("AGILENT TECHNOLOGIES (INTERNATIONAL) PVT.LTD.");
			formSixteenDetail.setPan_deductor("AADCA4115C");
			formSixteenDetail.setTan_deductor("RTKA01588G");
			formSixteenDetail.setAddress("CP-11, SECTOR 8, IMT MANESAR, GURGAON - 122051, HARYANA");
			formSixteenDetail.setGross_a(931659D);
			formSixteenDetail.setGross_b(0D);
			formSixteenDetail.setGross_c(0D);
			formSixteenDetail.setGross_total(931659D);
			formSixteenDetail.setLess_total_2(261485D);
			formSixteenDetail.setBalance(670174D);
			...
			formSixteenDetail.setIncome_chargable_total(670174D);
			...
			formSixteenDetail.setDed_ent1(45355D);
			...
			System.out.println("bigTotalTdsPension::::"+bigTotalTdsPension);
			...
			houseIncomeDetail.setAddress("");
			houseIncomeDetail.setCity("");
			houseIncomeDetail.setStates("");
			houseIncomeDetail.setPin("");
			houseIncomeDetail.setLetOut("");
			houseIncomeDetail.setCoowned("");
			houseIncomeDetail.setLetable_value(0D);
			houseIncomeDetail.setUnrealised_rent(0D);
			houseIncomeDetail.setLocal_tax(0D);
			houseIncomeDetail.setTotal(0D);
			houseIncomeDetail.setBalance(0D);
			houseIncomeDetail.setInterest_borrowed(0D);
			houseIncomeDetail.setIncome_hproperty(0D);
			houseProperty.setTotal_HouseIncome(0D);
			...
			otherIncomeDocument.setBank_detail_saving(0D);
			otherIncomeDocument.setTaxable_income(0D);
			mapOfBeans.put(OtherSourcesDocument.class.getSimpleName().toLowerCase(),otherIncomeDocument);	

			//Total Income (Salary Income+PensionIncome+HouseIncome+OtherIncome)
			...
			deductionDocumentDetail.setSection("80c");
			deductionDocumentDetail.setHead("80c");
			deductionDocumentDetail.setInvestment(135650D);
			listOfDeductionDocumentDetail.add(deductionDocumentDetail);
			System.out.println("80C:::"+deductionDocumentDetail.getInvestment());
			if (deductionDocumentDetail.getInvestment() > 100000D){
				deductionDocumentDetail.setMaxAllowed(100000D);
				deductionDocumentDetail.setInvestment(deductionDocumentDetail.getMaxAllowed());
			}	
			deductionDocument.setDeductionDocumentDetailList(listOfDeductionDocumentDetail);
			
			System.out.println("Deduction 80C::"+deductionDocumentDetail.getInvestment());			
			BigInteger bigDeduction = indianCurrencyHelper.bigIntegerRound(deductionDocumentDetail.getInvestment());
			...
			System.out.println("Toatl TDS (salary + Pension)"+bigTotalTds);
			...
			assertTrue("Failed Refund Income", (PayIncome.equals(new BigInteger("0"))));
		} catch (Exception e) {
