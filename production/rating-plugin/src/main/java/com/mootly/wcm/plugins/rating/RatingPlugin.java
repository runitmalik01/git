...
package com.mootly.wcm.plugins.rating;
    ...
    public RatingPlugin(IPluginContext context, IPluginConfig config) {
        ...
        try {
            ...
            if (parent.isNodeType("mix:referenceable")) {
                String query = "//*[(*/@hippo:docbase = '" + parent.getUUID() + "') and (@jcr:primaryType='mootlywcm:review')]";
                ...
                while (iterator.hasNext()) {
                    ...
                    if (review.hasProperty("mootlywcm:rating")) {
                        totalRating += review.getProperty("mootlywcm:rating").getLong();
                    }
                }
                ...
                if (mode == IEditor.Mode.EDIT) {
                    productNode.setProperty("mootlywcm:rating", avgRating);
                    productNode.setProperty("mootlywcm:votes", reviewCount);
                }
            }
