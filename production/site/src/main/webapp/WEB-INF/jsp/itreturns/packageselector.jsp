	...
	<form id="frmdata" method="post" action="${actionURL}">
		...
		<c:if test="${(financialYear.displayName eq '2012-2013')}">
			<c:choose>
							...
							<table class="table" width="100%">
								...
								<tr>
									<th width="15%"><fmt:message
											key="service.price.description" /></th>
									<c:forEach items="${documents}" var="document">
								...
								<tr>
									...
									<c:forEach items="${documents}" var="document">
										<td width="5%">
											...
											</c:forEach> <br /> <a href='<hst:link path="/serviceprice"/>'
											target="_blank">Know More</a></td>
									</c:forEach>
								</tr>
							</table>
						</div>
						...
						<div class="tab-pane fade" id="assistedfiling">
							<div id="#assistedfiling">
								...
								<b><i>File with assistance of Tax Professionals from
										anywhere!</i> </b><br />
								<div class="tabText">
									<span class="tab2SubHeading"><strong>1.
											Schedule an Appointment</strong> </span><br /> <span
										class="fontArial fontSize12 ">Schedule an appointment
										with a tax expert by paying a small fee.</span>
								</div>
								<div class="tabText1">
									<span class="tab2SubHeading"><strong>2. Share
											your tax document</strong> </span><br /> <span class="fontArial fontSize12 ">Upload
										your documents that will help the expert to prepare your
										return.</span>
								</div>
								<div class="tabText1">
								...
								<div class="tabText1">
									<span class="tab2SubHeading"><strong>5. Payment</strong>
									</span><br /> <span class="fontArial fontSize12 ">Pay your fee
										online or by cheque.</span>
								</div>
								<div class="tabText1">
									<span class="tab2SubHeading"><strong>6. Filing</strong>
				...
				<c:otherwise>
					<ul id="myTab" class="nav nav-tabs">
						<li class="active"><a href="#assistedfiling"
							data-toggle="tab">Assisted Filing</a></li>
					</ul>
