...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  xmlns:ns2="http://incometaxindiaefiling.gov.in/ITR1" xmlns:t="http://incometaxindiaefiling.gov.in/master">
<xsl:output method="html"></xsl:output>
	...
	<xsl:template match="t:PersonalInfo">
		<table  width="100%" border="1">
			<tr>
				<td>Assessee Name</td><td><xsl:value-of select="t:AssesseeName"/><xsl:value-of select="t:AssesseeName"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Address</td>
				<td>
					<xsl:value-of select="t:Address/t:ResidenceNo"/><br/>
					<xsl:value-of select="t:Address/t:RoadOrStreet"/><br/>
					<xsl:value-of select="t:Address/t:LocalityOrArea"/><br/>
					<xsl:value-of select="t:Address/t:CityOrTownOrDistrict"/><br/>
